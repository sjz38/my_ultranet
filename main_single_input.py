...
yolo_bias_dtype = hcl.Fixed(11,8) # TODO seems to work given values in bias term
...
if __name__ == "__main__":
    ...
    ultranet_out = torch.tensor(np_out)

    ###############################################################################
    # YOLO Layer (after conv)
    ###############################################################################
