...
heterocl_res = np.load('batch_norm_test_heterocl.npy')
pytorch_res = np.load('batch_norm_test_reference.npy')
...
print(np.allclose(heterocl_res, pytorch_res, atol=1e-1))