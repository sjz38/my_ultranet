...
// ==============================================================
#ifndef __test_mac_muladd_6mkb__HH__
#define __test_mac_muladd_6mkb__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(test_mac_muladd_6mkb) {
    ...
    SC_CTOR(test_mac_muladd_6mkb):  simcore_mac_5_U ("simcore_mac_5_U") {
