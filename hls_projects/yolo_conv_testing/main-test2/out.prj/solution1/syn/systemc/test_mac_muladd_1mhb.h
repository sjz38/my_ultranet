...
// ==============================================================
#ifndef __test_mac_muladd_1mhb__HH__
#define __test_mac_muladd_1mhb__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(test_mac_muladd_1mhb) {
    ...
    SC_CTOR(test_mac_muladd_1mhb):  simcore_mac_2_U ("simcore_mac_2_U") {
