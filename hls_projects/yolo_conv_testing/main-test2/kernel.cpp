...
void test(ap_fixed<8, 4> input_image[1][3][160][320], ap_fixed<5, 2> weight_conv1[16][3][3][3], ap_fixed<14, 4> a_batchnorm1[16], ap_fixed<26, 8> b_batchnorm1[16], ap_fixed<5, 2> weight_conv2[32][16][3][3], ap_fixed<14, 4> a_batchnorm2[32], ap_fixed<26, 8> b_batchnorm2[32], ap_fixed<5, 2> weight_conv3[64][32][3][3], ap_fixed<14, 4> a_batchnorm3[64], ap_fixed<26, 8> b_batchnorm3[64], ap_fixed<5, 2> weight_conv4[64][64][3][3], ap_fixed<14, 4> a_batchnorm4[64], ap_fixed<26, 8> b_batchnorm4[64], ap_fixed<5, 2> weight_conv5[64][64][3][3], ap_fixed<14, 4> a_batchnorm5[64], ap_fixed<26, 8> b_batchnorm5[64], ap_fixed<5, 2> weight_conv6[64][64][3][3], ap_fixed<14, 4> a_batchnorm6[64], ap_fixed<26, 8> b_batchnorm6[64], ap_fixed<5, 2> weight_conv7[64][64][3][3], ap_fixed<14, 4> a_batchnorm7[64], ap_fixed<26, 8> b_batchnorm7[64], ap_fixed<5, 2> weight_conv8[64][64][3][3], ap_fixed<14, 4> a_batchnorm8[64], ap_fixed<26, 8> b_batchnorm8[64], ap_fixed<5, 2> weight_yolo[36][64][1][1], ap_fixed<11, 3> bias_yolo[36], ap_fixed<16, 8> result[1][36][10][20]) {
    #pragma HLS array_partition variable=weight_yolo complete dim=2
    ...
    #pragma HLS dataflow
    hls::stream<ap_fixed<8, 4> > conv1_pad_pipe_1;
    #pragma HLS stream variable=conv1_pad_pipe_1 depth=128
    ...
    hls::stream<ap_fixed<16, 8> > conv1_pipe_9;
    #pragma HLS stream variable=conv1_pipe_9 depth=128
        ...
        conv1_yy_reuse: for (int yy_reuse = 0; yy_reuse < 162; ++yy_reuse) {
          ...
          #pragma HLS pipeline
            conv1_pad_2: for (int conv1_pad_2 = 0; conv1_pad_2 < 3; ++conv1_pad_2) {
              ...
              ap_fixed<8, 4> conv1_pad_temp1;
              conv1_pad_temp1 = conv1_pad_pipe_1.read();
              conv1_line_buffer[0][conv1_pad_2][2][xx_reuse] = conv1_pad_temp1;
            }
            if (2 <= yy_reuse) {
    ...
    hls::stream<ap_ufixed<6, 2> > relu1_pipe_10;
    #pragma HLS stream variable=relu1_pipe_10 depth=128
      ...
      relu1_args0: for (int args0 = 0; args0 < 16; ++args0) {
        relu1_args1: for (int args1 = 0; args1 < 160; ++args1) {
          ...
          #pragma HLS pipeline
            ...
            ap_ufixed<6, 2> relu1_temp;
            relu1_temp = ((ap_ufixed<6, 2>)((((ap_fixed<40, 32>)batch_norm1) < (ap_fixed<40, 32>)0) ? (((ap_fixed<16, 8>)0)) : ((ap_fixed<16, 8>)(((ap_fixed<40, 32>)1 < ((ap_fixed<40, 32>)batch_norm1)) ? (((ap_fixed<16, 8>)1)) : ((ap_fixed<16, 8>)batch_norm1)))));
            relu1_pipe_10.write(relu1_temp);
          }
        }
      }
    }
    ap_ufixed<6, 2> pool1_pad[1][16][160][320];
    hls::stream<ap_ufixed<6, 2> > pool1_pad_pipe_11;
    #pragma HLS stream variable=pool1_pad_pipe_11 depth=128
    pool1_pad_indices1: for (int indices1 = 0; indices1 < 1; ++indices1) {
      pool1_pad_not_zero1: for (int not_zero1 = 0; not_zero1 < 16; ++not_zero1) {
        pool1_pad_index_tuple1: for (int index_tuple1 = 0; index_tuple1 < 160; ++index_tuple1) {
          ...
          #pragma HLS pipeline
            ap_ufixed<6, 2> relu1_temp1;
            relu1_temp1 = relu1_pipe_10.read();
            ap_ufixed<6, 2> pool1_pad_temp;
            pool1_pad_temp = relu1_temp1;
            pool1_pad_pipe_11.write(pool1_pad_temp);
          }
        }
      }
    }
    ap_ufixed<6, 2> pool1[1][16][80][160];
    hls::stream<ap_ufixed<6, 2> > pool1_pipe_12;
    #pragma HLS stream variable=pool1_pipe_12 depth=128
          ...
          #pragma HLS pipeline
            ...
            pool1_ra38: for (int ra38 = 0; ra38 < 2; ++ra38) {
              pool1_ra39: for (int ra39 = 0; ra39 < 2; ++ra39) {
                ap_ufixed<6, 2> pool1_pad_temp1;
                pool1_pad_temp1 = pool1_pad_pipe_11.read();
                reducer4 = hls::max(pool1_pad_temp1, reducer4);
              }
            }
            ap_ufixed<6, 2> pool1_temp;
            pool1_temp = reducer4;
            pool1_pipe_12.write(pool1_temp);
          }
        }
      }
    }
    ap_ufixed<6, 2> conv2_pad[1][16][82][162];
    hls::stream<ap_ufixed<6, 2> > conv2_pad_pipe_2;
    #pragma HLS stream variable=conv2_pad_pipe_2 depth=128
    conv2_pad_indices2: for (int indices2 = 0; indices2 < 1; ++indices2) {
      conv2_pad_not_zero2: for (int not_zero2 = 0; not_zero2 < 16; ++not_zero2) {
        conv2_pad_index_tuple2: for (int index_tuple2 = 0; index_tuple2 < 82; ++index_tuple2) {
          ...
          #pragma HLS pipeline
            ap_ufixed<6, 2> conv2_pad_temp;
            ap_ufixed<6, 2> pool1_temp1;
            if ((((1 <= index_tuple2) && (index_tuple2 < 81)) && (1 <= i3)) && (i3 < 161)) {
              pool1_temp1 = pool1_pipe_12.read();
              conv2_pad_temp = pool1_temp1;
            } else {
              pool1_temp1 = 0;
              conv2_pad_temp = (ap_ufixed<6, 2>)0;
            }
            conv2_pad_pipe_2.write(conv2_pad_temp);
            conv2_pad[indices2][not_zero2][index_tuple2][i3] = conv2_pad_temp;
          }
        }
      }
    }
    ...
    hls::stream<ap_fixed<16, 8> > conv2_pipe_13;
    #pragma HLS stream variable=conv2_pipe_13 depth=128
        ...
        conv2_yy_reuse1: for (int yy_reuse1 = 0; yy_reuse1 < 82; ++yy_reuse1) {
          ...
          #pragma HLS pipeline
            conv2_pad_2: for (int conv2_pad_2 = 0; conv2_pad_2 < 16; ++conv2_pad_2) {
              ...
              ap_ufixed<6, 2> conv2_pad_temp1;
              conv2_pad_temp1 = conv2_pad_pipe_2.read();
              conv2_line_buffer[0][conv2_pad_2][2][xx_reuse1] = conv2_pad_temp1;
            }
            if (2 <= yy_reuse1) {
              ...
              if (2 <= xx_reuse1) {
                ...
                conv2_temp = sum_;
                conv2_pipe_13.write(conv2_temp);
              }
            }
          }
        }
    ...
    hls::stream<ap_ufixed<6, 2> > relu2_pipe_14;
    #pragma HLS stream variable=relu2_pipe_14 depth=128
      ...
      relu2_args01: for (int args01 = 0; args01 < 32; ++args01) {
        relu2_args11: for (int args11 = 0; args11 < 80; ++args11) {
          ...
          #pragma HLS pipeline
            ...
            conv2_temp1 = conv2_pipe_13.read();
            ...
            ap_ufixed<6, 2> relu2_temp;
            relu2_temp = ((ap_ufixed<6, 2>)((((ap_fixed<40, 32>)batch_norm2) < (ap_fixed<40, 32>)0) ? (((ap_fixed<16, 8>)0)) : ((ap_fixed<16, 8>)(((ap_fixed<40, 32>)1 < ((ap_fixed<40, 32>)batch_norm2)) ? (((ap_fixed<16, 8>)1)) : ((ap_fixed<16, 8>)batch_norm2)))));
            relu2_pipe_14.write(relu2_temp);
          }
        }
      }
    }
    ap_ufixed<6, 2> pool2_pad[1][32][80][160];
    hls::stream<ap_ufixed<6, 2> > pool2_pad_pipe_15;
    #pragma HLS stream variable=pool2_pad_pipe_15 depth=128
    pool2_pad_indices3: for (int indices3 = 0; indices3 < 1; ++indices3) {
      pool2_pad_not_zero3: for (int not_zero3 = 0; not_zero3 < 32; ++not_zero3) {
        pool2_pad_index_tuple3: for (int index_tuple3 = 0; index_tuple3 < 80; ++index_tuple3) {
          ...
          #pragma HLS pipeline
            ap_ufixed<6, 2> relu2_temp1;
            relu2_temp1 = relu2_pipe_14.read();
            ap_ufixed<6, 2> pool2_pad_temp;
            pool2_pad_temp = relu2_temp1;
            pool2_pad_pipe_15.write(pool2_pad_temp);
          }
        }
      }
    }
    ap_ufixed<6, 2> pool2[1][32][40][80];
    hls::stream<ap_ufixed<6, 2> > pool2_pipe_16;
    #pragma HLS stream variable=pool2_pipe_16 depth=128
          ...
          #pragma HLS pipeline
            ...
            pool2_ra43: for (int ra43 = 0; ra43 < 2; ++ra43) {
              pool2_ra44: for (int ra44 = 0; ra44 < 2; ++ra44) {
                ap_ufixed<6, 2> pool2_pad_temp1;
                pool2_pad_temp1 = pool2_pad_pipe_15.read();
                reducer5 = hls::max(pool2_pad_temp1, reducer5);
              }
            }
            ap_ufixed<6, 2> pool2_temp;
            pool2_temp = reducer5;
            pool2_pipe_16.write(pool2_temp);
          }
        }
      }
    }
    ap_ufixed<6, 2> conv3_pad[1][32][42][82];
    hls::stream<ap_ufixed<6, 2> > conv3_pad_pipe_3;
    #pragma HLS stream variable=conv3_pad_pipe_3 depth=128
    conv3_pad_indices4: for (int indices4 = 0; indices4 < 1; ++indices4) {
      conv3_pad_not_zero4: for (int not_zero4 = 0; not_zero4 < 32; ++not_zero4) {
        conv3_pad_index_tuple4: for (int index_tuple4 = 0; index_tuple4 < 42; ++index_tuple4) {
          ...
          #pragma HLS pipeline
            ap_ufixed<6, 2> conv3_pad_temp;
            ap_ufixed<6, 2> pool2_temp1;
            if ((((1 <= index_tuple4) && (index_tuple4 < 41)) && (1 <= i6)) && (i6 < 81)) {
              pool2_temp1 = pool2_pipe_16.read();
              conv3_pad_temp = pool2_temp1;
            } else {
              pool2_temp1 = 0;
              conv3_pad_temp = (ap_ufixed<6, 2>)0;
            }
            conv3_pad_pipe_3.write(conv3_pad_temp);
            conv3_pad[indices4][not_zero4][index_tuple4][i6] = conv3_pad_temp;
          }
        }
      }
    }
    ...
    hls::stream<ap_fixed<16, 8> > conv3_pipe_17;
    #pragma HLS stream variable=conv3_pipe_17 depth=128
        ...
        conv3_yy_reuse2: for (int yy_reuse2 = 0; yy_reuse2 < 42; ++yy_reuse2) {
          ...
          #pragma HLS pipeline
            conv3_pad_2: for (int conv3_pad_2 = 0; conv3_pad_2 < 32; ++conv3_pad_2) {
              ...
              ap_ufixed<6, 2> conv3_pad_temp1;
              conv3_pad_temp1 = conv3_pad_pipe_3.read();
              conv3_line_buffer[0][conv3_pad_2][2][xx_reuse2] = conv3_pad_temp1;
            }
            if (2 <= yy_reuse2) {
              ...
              if (2 <= xx_reuse2) {
                ...
                conv3_temp = sum__;
                conv3_pipe_17.write(conv3_temp);
              }
            }
          }
        }
    ...
    hls::stream<ap_ufixed<6, 2> > relu3_pipe_18;
    #pragma HLS stream variable=relu3_pipe_18 depth=128
      ...
      relu3_args02: for (int args02 = 0; args02 < 64; ++args02) {
        relu3_args12: for (int args12 = 0; args12 < 40; ++args12) {
          ...
          #pragma HLS pipeline
            ...
            conv3_temp1 = conv3_pipe_17.read();
            ...
            ap_ufixed<6, 2> relu3_temp;
            relu3_temp = ((ap_ufixed<6, 2>)((((ap_fixed<40, 32>)batch_norm3) < (ap_fixed<40, 32>)0) ? (((ap_fixed<16, 8>)0)) : ((ap_fixed<16, 8>)(((ap_fixed<40, 32>)1 < ((ap_fixed<40, 32>)batch_norm3)) ? (((ap_fixed<16, 8>)1)) : ((ap_fixed<16, 8>)batch_norm3)))));
            relu3_pipe_18.write(relu3_temp);
          }
        }
      }
    }
    ap_ufixed<6, 2> pool3_pad[1][64][40][80];
    hls::stream<ap_ufixed<6, 2> > pool3_pad_pipe_19;
    #pragma HLS stream variable=pool3_pad_pipe_19 depth=128
    pool3_pad_indices5: for (int indices5 = 0; indices5 < 1; ++indices5) {
      pool3_pad_not_zero5: for (int not_zero5 = 0; not_zero5 < 64; ++not_zero5) {
        pool3_pad_index_tuple5: for (int index_tuple5 = 0; index_tuple5 < 40; ++index_tuple5) {
          ...
          #pragma HLS pipeline
            ap_ufixed<6, 2> relu3_temp1;
            relu3_temp1 = relu3_pipe_18.read();
            ap_ufixed<6, 2> pool3_pad_temp;
            pool3_pad_temp = relu3_temp1;
            pool3_pad_pipe_19.write(pool3_pad_temp);
          }
        }
      }
    }
    ap_ufixed<6, 2> pool3[1][64][20][40];
    hls::stream<ap_ufixed<6, 2> > pool3_pipe_20;
    #pragma HLS stream variable=pool3_pipe_20 depth=128
          ...
          #pragma HLS pipeline
            ...
            pool3_ra48: for (int ra48 = 0; ra48 < 2; ++ra48) {
              pool3_ra49: for (int ra49 = 0; ra49 < 2; ++ra49) {
                ap_ufixed<6, 2> pool3_pad_temp1;
                pool3_pad_temp1 = pool3_pad_pipe_19.read();
                reducer6 = hls::max(pool3_pad_temp1, reducer6);
              }
            }
            ap_ufixed<6, 2> pool3_temp;
            pool3_temp = reducer6;
            pool3_pipe_20.write(pool3_temp);
          }
        }
      }
    }
    ap_ufixed<6, 2> conv4_pad[1][64][22][42];
    hls::stream<ap_ufixed<6, 2> > conv4_pad_pipe_4;
    #pragma HLS stream variable=conv4_pad_pipe_4 depth=128
    conv4_pad_indices6: for (int indices6 = 0; indices6 < 1; ++indices6) {
      conv4_pad_not_zero6: for (int not_zero6 = 0; not_zero6 < 64; ++not_zero6) {
        conv4_pad_index_tuple6: for (int index_tuple6 = 0; index_tuple6 < 22; ++index_tuple6) {
          ...
          #pragma HLS pipeline
            ap_ufixed<6, 2> conv4_pad_temp;
            ap_ufixed<6, 2> pool3_temp1;
            if ((((1 <= index_tuple6) && (index_tuple6 < 21)) && (1 <= i9)) && (i9 < 41)) {
              pool3_temp1 = pool3_pipe_20.read();
              conv4_pad_temp = pool3_temp1;
            } else {
              pool3_temp1 = 0;
              conv4_pad_temp = (ap_ufixed<6, 2>)0;
            }
            conv4_pad_pipe_4.write(conv4_pad_temp);
            conv4_pad[indices6][not_zero6][index_tuple6][i9] = conv4_pad_temp;
          }
        }
      }
    }
    ...
    hls::stream<ap_fixed<16, 8> > conv4_pipe_21;
    #pragma HLS stream variable=conv4_pipe_21 depth=128
        ...
        conv4_yy_reuse3: for (int yy_reuse3 = 0; yy_reuse3 < 22; ++yy_reuse3) {
          ...
          #pragma HLS pipeline
            conv4_pad_2: for (int conv4_pad_2 = 0; conv4_pad_2 < 64; ++conv4_pad_2) {
              ...
              ap_ufixed<6, 2> conv4_pad_temp1;
              conv4_pad_temp1 = conv4_pad_pipe_4.read();
              conv4_line_buffer[0][conv4_pad_2][2][xx_reuse3] = conv4_pad_temp1;
            }
            if (2 <= yy_reuse3) {
              ...
              if (2 <= xx_reuse3) {
                ...
                conv4_temp = sum___;
                conv4_pipe_21.write(conv4_temp);
              }
            }
          }
        }
    ...
    hls::stream<ap_ufixed<6, 2> > relu4_pipe_22;
    #pragma HLS stream variable=relu4_pipe_22 depth=128
      ...
      relu4_args03: for (int args03 = 0; args03 < 64; ++args03) {
        relu4_args13: for (int args13 = 0; args13 < 20; ++args13) {
          ...
          #pragma HLS pipeline
            ...
            conv4_temp1 = conv4_pipe_21.read();
            ...
            ap_ufixed<6, 2> relu4_temp;
            relu4_temp = ((ap_ufixed<6, 2>)((((ap_fixed<40, 32>)batch_norm4) < (ap_fixed<40, 32>)0) ? (((ap_fixed<16, 8>)0)) : ((ap_fixed<16, 8>)(((ap_fixed<40, 32>)1 < ((ap_fixed<40, 32>)batch_norm4)) ? (((ap_fixed<16, 8>)1)) : ((ap_fixed<16, 8>)batch_norm4)))));
            relu4_pipe_22.write(relu4_temp);
          }
        }
      }
    }
    ap_ufixed<6, 2> pool4_pad[1][64][20][40];
    hls::stream<ap_ufixed<6, 2> > pool4_pad_pipe_23;
    #pragma HLS stream variable=pool4_pad_pipe_23 depth=128
    pool4_pad_indices7: for (int indices7 = 0; indices7 < 1; ++indices7) {
      pool4_pad_not_zero7: for (int not_zero7 = 0; not_zero7 < 64; ++not_zero7) {
        pool4_pad_index_tuple7: for (int index_tuple7 = 0; index_tuple7 < 20; ++index_tuple7) {
          ...
          #pragma HLS pipeline
            ap_ufixed<6, 2> relu4_temp1;
            relu4_temp1 = relu4_pipe_22.read();
            ap_ufixed<6, 2> pool4_pad_temp;
            pool4_pad_temp = relu4_temp1;
            pool4_pad_pipe_23.write(pool4_pad_temp);
          }
        }
      }
    }
    ap_ufixed<6, 2> pool4[1][64][10][20];
    hls::stream<ap_ufixed<6, 2> > pool4_pipe_24;
    #pragma HLS stream variable=pool4_pipe_24 depth=128
          ...
          #pragma HLS pipeline
            ...
            pool4_ra53: for (int ra53 = 0; ra53 < 2; ++ra53) {
              pool4_ra54: for (int ra54 = 0; ra54 < 2; ++ra54) {
                ap_ufixed<6, 2> pool4_pad_temp1;
                pool4_pad_temp1 = pool4_pad_pipe_23.read();
                reducer7 = hls::max(pool4_pad_temp1, reducer7);
              }
            }
            ap_ufixed<6, 2> pool4_temp;
            pool4_temp = reducer7;
            pool4_pipe_24.write(pool4_temp);
          }
        }
      }
    }
    ap_ufixed<6, 2> conv5_pad[1][64][12][22];
    hls::stream<ap_ufixed<6, 2> > conv5_pad_pipe_5;
    #pragma HLS stream variable=conv5_pad_pipe_5 depth=128
    conv5_pad_indices8: for (int indices8 = 0; indices8 < 1; ++indices8) {
      conv5_pad_not_zero8: for (int not_zero8 = 0; not_zero8 < 64; ++not_zero8) {
        conv5_pad_index_tuple8: for (int index_tuple8 = 0; index_tuple8 < 12; ++index_tuple8) {
          ...
          #pragma HLS pipeline
            ap_ufixed<6, 2> conv5_pad_temp;
            ap_ufixed<6, 2> pool4_temp1;
            if ((((1 <= index_tuple8) && (index_tuple8 < 11)) && (1 <= i12)) && (i12 < 21)) {
              pool4_temp1 = pool4_pipe_24.read();
              conv5_pad_temp = pool4_temp1;
            } else {
              pool4_temp1 = 0;
              conv5_pad_temp = (ap_ufixed<6, 2>)0;
            }
            conv5_pad_pipe_5.write(conv5_pad_temp);
            conv5_pad[indices8][not_zero8][index_tuple8][i12] = conv5_pad_temp;
          }
        }
      }
    }
    ...
    hls::stream<ap_fixed<16, 8> > conv5_pipe_25;
    #pragma HLS stream variable=conv5_pipe_25 depth=128
        ...
        conv5_yy_reuse4: for (int yy_reuse4 = 0; yy_reuse4 < 12; ++yy_reuse4) {
          ...
          #pragma HLS pipeline
            conv5_pad_2: for (int conv5_pad_2 = 0; conv5_pad_2 < 64; ++conv5_pad_2) {
              ...
              ap_ufixed<6, 2> conv5_pad_temp1;
              conv5_pad_temp1 = conv5_pad_pipe_5.read();
              conv5_line_buffer[0][conv5_pad_2][2][xx_reuse4] = conv5_pad_temp1;
            }
            if (2 <= yy_reuse4) {
              ...
              if (2 <= xx_reuse4) {
                ...
                conv5_temp = sum____;
                conv5_pipe_25.write(conv5_temp);
              }
            }
          }
        }
    ...
    hls::stream<ap_ufixed<6, 2> > relu5_pipe_26;
    #pragma HLS stream variable=relu5_pipe_26 depth=128
      ...
      relu5_args04: for (int args04 = 0; args04 < 64; ++args04) {
        relu5_args14: for (int args14 = 0; args14 < 10; ++args14) {
          ...
          #pragma HLS pipeline
            ...
            conv5_temp1 = conv5_pipe_25.read();
            ...
            ap_ufixed<6, 2> relu5_temp;
            relu5_temp = ((ap_ufixed<6, 2>)((((ap_fixed<40, 32>)batch_norm5) < (ap_fixed<40, 32>)0) ? (((ap_fixed<16, 8>)0)) : ((ap_fixed<16, 8>)(((ap_fixed<40, 32>)1 < ((ap_fixed<40, 32>)batch_norm5)) ? (((ap_fixed<16, 8>)1)) : ((ap_fixed<16, 8>)batch_norm5)))));
            relu5_pipe_26.write(relu5_temp);
          }
        }
      }
    }
    ap_ufixed<6, 2> conv6_pad[1][64][12][22];
    hls::stream<ap_ufixed<6, 2> > conv6_pad_pipe_6;
    #pragma HLS stream variable=conv6_pad_pipe_6 depth=128
    conv6_pad_indices9: for (int indices9 = 0; indices9 < 1; ++indices9) {
      conv6_pad_not_zero9: for (int not_zero9 = 0; not_zero9 < 64; ++not_zero9) {
        conv6_pad_index_tuple9: for (int index_tuple9 = 0; index_tuple9 < 12; ++index_tuple9) {
          ...
          #pragma HLS pipeline
            ap_ufixed<6, 2> conv6_pad_temp;
            ap_ufixed<6, 2> relu5_temp1;
            if ((((1 <= index_tuple9) && (index_tuple9 < 11)) && (1 <= i13)) && (i13 < 21)) {
              relu5_temp1 = relu5_pipe_26.read();
              conv6_pad_temp = relu5_temp1;
            } else {
              relu5_temp1 = 0;
              conv6_pad_temp = (ap_ufixed<6, 2>)0;
            }
            conv6_pad_pipe_6.write(conv6_pad_temp);
            conv6_pad[indices9][not_zero9][index_tuple9][i13] = conv6_pad_temp;
          }
        }
      }
    }
    ...
    hls::stream<ap_fixed<16, 8> > conv6_pipe_27;
    #pragma HLS stream variable=conv6_pipe_27 depth=128
        ...
        conv6_yy_reuse5: for (int yy_reuse5 = 0; yy_reuse5 < 12; ++yy_reuse5) {
          ...
          #pragma HLS pipeline
            conv6_pad_2: for (int conv6_pad_2 = 0; conv6_pad_2 < 64; ++conv6_pad_2) {
              ...
              ap_ufixed<6, 2> conv6_pad_temp1;
              conv6_pad_temp1 = conv6_pad_pipe_6.read();
              conv6_line_buffer[0][conv6_pad_2][2][xx_reuse5] = conv6_pad_temp1;
            }
            if (2 <= yy_reuse5) {
              ...
              if (2 <= xx_reuse5) {
                ...
                conv6_temp = sum_____;
                conv6_pipe_27.write(conv6_temp);
              }
            }
          }
        }
    ...
    hls::stream<ap_ufixed<6, 2> > relu6_pipe_28;
    #pragma HLS stream variable=relu6_pipe_28 depth=128
      ...
      relu6_args05: for (int args05 = 0; args05 < 64; ++args05) {
        relu6_args15: for (int args15 = 0; args15 < 10; ++args15) {
          ...
          #pragma HLS pipeline
            ...
            conv6_temp1 = conv6_pipe_27.read();
            ...
            ap_ufixed<6, 2> relu6_temp;
            relu6_temp = ((ap_ufixed<6, 2>)((((ap_fixed<40, 32>)batch_norm6) < (ap_fixed<40, 32>)0) ? (((ap_fixed<16, 8>)0)) : ((ap_fixed<16, 8>)(((ap_fixed<40, 32>)1 < ((ap_fixed<40, 32>)batch_norm6)) ? (((ap_fixed<16, 8>)1)) : ((ap_fixed<16, 8>)batch_norm6)))));
            relu6_pipe_28.write(relu6_temp);
          }
        }
      }
    }
    ap_ufixed<6, 2> conv7_pad[1][64][12][22];
    hls::stream<ap_ufixed<6, 2> > conv7_pad_pipe_7;
    #pragma HLS stream variable=conv7_pad_pipe_7 depth=128
    conv7_pad_indices10: for (int indices10 = 0; indices10 < 1; ++indices10) {
      conv7_pad_not_zero10: for (int not_zero10 = 0; not_zero10 < 64; ++not_zero10) {
        conv7_pad_index_tuple10: for (int index_tuple10 = 0; index_tuple10 < 12; ++index_tuple10) {
          ...
          #pragma HLS pipeline
            ap_ufixed<6, 2> conv7_pad_temp;
            ap_ufixed<6, 2> relu6_temp1;
            if ((((1 <= index_tuple10) && (index_tuple10 < 11)) && (1 <= i14)) && (i14 < 21)) {
              relu6_temp1 = relu6_pipe_28.read();
              conv7_pad_temp = relu6_temp1;
            } else {
              relu6_temp1 = 0;
              conv7_pad_temp = (ap_ufixed<6, 2>)0;
            }
            conv7_pad_pipe_7.write(conv7_pad_temp);
            conv7_pad[indices10][not_zero10][index_tuple10][i14] = conv7_pad_temp;
          }
        }
      }
    }
    ...
    hls::stream<ap_fixed<16, 8> > conv7_pipe_29;
    #pragma HLS stream variable=conv7_pipe_29 depth=128
        ...
        conv7_yy_reuse6: for (int yy_reuse6 = 0; yy_reuse6 < 12; ++yy_reuse6) {
          ...
          #pragma HLS pipeline
            conv7_pad_2: for (int conv7_pad_2 = 0; conv7_pad_2 < 64; ++conv7_pad_2) {
              ...
              ap_ufixed<6, 2> conv7_pad_temp1;
              conv7_pad_temp1 = conv7_pad_pipe_7.read();
              conv7_line_buffer[0][conv7_pad_2][2][xx_reuse6] = conv7_pad_temp1;
            }
            if (2 <= yy_reuse6) {
              ...
              if (2 <= xx_reuse6) {
                ...
                conv7_pipe_29.write(conv7_temp);
              }
            }
          }
        }
    ...
    hls::stream<ap_ufixed<6, 2> > relu7_pipe_30;
    #pragma HLS stream variable=relu7_pipe_30 depth=128
      ...
      relu7_args06: for (int args06 = 0; args06 < 64; ++args06) {
        relu7_args16: for (int args16 = 0; args16 < 10; ++args16) {
          ...
          #pragma HLS pipeline
            ...
            conv7_temp1 = conv7_pipe_29.read();
            ...
            ap_ufixed<6, 2> relu7_temp;
            relu7_temp = ((ap_ufixed<6, 2>)((((ap_fixed<40, 32>)batch_norm7) < (ap_fixed<40, 32>)0) ? (((ap_fixed<16, 8>)0)) : ((ap_fixed<16, 8>)(((ap_fixed<40, 32>)1 < ((ap_fixed<40, 32>)batch_norm7)) ? (((ap_fixed<16, 8>)1)) : ((ap_fixed<16, 8>)batch_norm7)))));
            relu7_pipe_30.write(relu7_temp);
          }
        }
      }
    }
    ap_ufixed<6, 2> conv8_pad[1][64][12][22];
    hls::stream<ap_ufixed<6, 2> > conv8_pad_pipe_8;
    #pragma HLS stream variable=conv8_pad_pipe_8 depth=128
    conv8_pad_indices11: for (int indices11 = 0; indices11 < 1; ++indices11) {
      conv8_pad_not_zero11: for (int not_zero11 = 0; not_zero11 < 64; ++not_zero11) {
        conv8_pad_index_tuple11: for (int index_tuple11 = 0; index_tuple11 < 12; ++index_tuple11) {
          ...
          #pragma HLS pipeline
            ap_ufixed<6, 2> conv8_pad_temp;
            ap_ufixed<6, 2> relu7_temp1;
            if ((((1 <= index_tuple11) && (index_tuple11 < 11)) && (1 <= i15)) && (i15 < 21)) {
              relu7_temp1 = relu7_pipe_30.read();
              conv8_pad_temp = relu7_temp1;
            } else {
              relu7_temp1 = 0;
              conv8_pad_temp = (ap_ufixed<6, 2>)0;
            }
            conv8_pad_pipe_8.write(conv8_pad_temp);
            conv8_pad[indices11][not_zero11][index_tuple11][i15] = conv8_pad_temp;
          }
        }
      }
    }
    ...
    hls::stream<ap_fixed<16, 8> > conv8_pipe_31;
    #pragma HLS stream variable=conv8_pipe_31 depth=128
        ...
        conv8_yy_reuse7: for (int yy_reuse7 = 0; yy_reuse7 < 12; ++yy_reuse7) {
          ...
          #pragma HLS pipeline
            conv8_pad_2: for (int conv8_pad_2 = 0; conv8_pad_2 < 64; ++conv8_pad_2) {
              ...
              ap_ufixed<6, 2> conv8_pad_temp1;
              conv8_pad_temp1 = conv8_pad_pipe_8.read();
              conv8_line_buffer[0][conv8_pad_2][2][xx_reuse7] = conv8_pad_temp1;
            }
            if (2 <= yy_reuse7) {
              ...
              if (2 <= xx_reuse7) {
                ...
                conv8_pipe_31.write(conv8_temp);
              }
            }
          }
        }
    ...
    relu8_y7: for (int y7 = 0; y7 < 1; ++y7) {
      relu8_args07: for (int args07 = 0; args07 < 64; ++args07) {
        relu8_args17: for (int args17 = 0; args17 < 10; ++args17) {
          relu8_args27: for (int args27 = 0; args27 < 20; ++args27) {
          #pragma HLS pipeline
            ap_fixed<16, 8> batch_norm8;
            ap_fixed<16, 8> conv8_temp1;
            conv8_temp1 = conv8_pipe_31.read();
            ...
            relu8[y7][args07][args17][args27] = ((ap_ufixed<6, 2>)((((ap_fixed<40, 32>)batch_norm8) < (ap_fixed<40, 32>)0) ? (((ap_fixed<16, 8>)0)) : ((ap_fixed<16, 8>)(((ap_fixed<40, 32>)1 < ((ap_fixed<40, 32>)batch_norm8)) ? (((ap_fixed<16, 8>)1)) : ((ap_fixed<16, 8>)batch_norm8)))));
          }
        }
      }
    }
    ...
    result_x13: for (int x13 = 0; x13 < 1; ++x13) {
      result_args08: for (int args08 = 0; args08 < 36; ++args08) {
        result_args18: for (int args18 = 0; args18 < 10; ++args18) {
          result_args28: for (int args28 = 0; args28 < 20; ++args28) {
          #pragma HLS pipeline
            result[x13][args08][args18][args28] = yolo[x13][args08][args18][args28];
          }
        }
      }
    }
