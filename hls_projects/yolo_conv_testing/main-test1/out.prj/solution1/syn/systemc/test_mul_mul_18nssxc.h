...
// ==============================================================
#ifndef __test_mul_mul_18nssxc__HH__
#define __test_mul_mul_18nssxc__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(test_mul_mul_18nssxc) {
    ...
    SC_CTOR(test_mul_mul_18nssxc):  ACMP_smul_us_U ("ACMP_smul_us_U") {
