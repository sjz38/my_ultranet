...
// ==============================================================
#ifndef __test_mac_muladd_7swc__HH__
#define __test_mac_muladd_7swc__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(test_mac_muladd_7swc) {
    ...
    SC_CTOR(test_mac_muladd_7swc):  simcore_mac_8_U ("simcore_mac_8_U") {
