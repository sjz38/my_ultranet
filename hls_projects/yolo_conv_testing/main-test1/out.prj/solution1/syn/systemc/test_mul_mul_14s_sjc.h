...
// ==============================================================
#ifndef __test_mul_mul_14s_sjc__HH__
#define __test_mul_mul_14s_sjc__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(test_mul_mul_14s_sjc) {
    ...
    SC_CTOR(test_mul_mul_14s_sjc):  ACMP_smul_ss_U ("ACMP_smul_ss_U") {
