...
// ==============================================================
#ifndef __test_mac_muladd_4snc__HH__
#define __test_mac_muladd_4snc__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(test_mac_muladd_4snc) {
    ...
    SC_CTOR(test_mac_muladd_4snc):  simcore_mac_5_U ("simcore_mac_5_U") {
