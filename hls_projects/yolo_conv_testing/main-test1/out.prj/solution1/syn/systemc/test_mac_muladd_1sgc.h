...
// ==============================================================
#ifndef __test_mac_muladd_1sgc__HH__
#define __test_mac_muladd_1sgc__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(test_mac_muladd_1sgc) {
    ...
    SC_CTOR(test_mac_muladd_1sgc):  simcore_mac_1_U ("simcore_mac_1_U") {
