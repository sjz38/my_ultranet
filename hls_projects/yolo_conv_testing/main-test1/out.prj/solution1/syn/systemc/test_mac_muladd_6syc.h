...
// ==============================================================
#ifndef __test_mac_muladd_6syc__HH__
#define __test_mac_muladd_6syc__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(test_mac_muladd_6syc) {
    ...
    SC_CTOR(test_mac_muladd_6syc):  simcore_mac_9_U ("simcore_mac_9_U") {
