...
void test(ap_fixed<8, 4> input_image[1][3][160][320], ap_fixed<5, 2> weight_conv1[16][3][3][3], ap_fixed<14, 4> a_batchnorm1[16], ap_fixed<26, 8> b_batchnorm1[16], ap_fixed<5, 2> weight_conv2[32][16][3][3], ap_fixed<14, 4> a_batchnorm2[32], ap_fixed<26, 8> b_batchnorm2[32], ap_fixed<5, 2> weight_conv3[64][32][3][3], ap_fixed<14, 4> a_batchnorm3[64], ap_fixed<26, 8> b_batchnorm3[64], ap_fixed<5, 2> weight_conv4[64][64][3][3], ap_fixed<14, 4> a_batchnorm4[64], ap_fixed<26, 8> b_batchnorm4[64], ap_fixed<5, 2> weight_conv5[64][64][3][3], ap_fixed<14, 4> a_batchnorm5[64], ap_fixed<26, 8> b_batchnorm5[64], ap_fixed<5, 2> weight_conv6[64][64][3][3], ap_fixed<14, 4> a_batchnorm6[64], ap_fixed<26, 8> b_batchnorm6[64], ap_fixed<5, 2> weight_conv7[64][64][3][3], ap_fixed<14, 4> a_batchnorm7[64], ap_fixed<26, 8> b_batchnorm7[64], ap_fixed<5, 2> weight_conv8[64][64][3][3], ap_fixed<14, 4> a_batchnorm8[64], ap_fixed<26, 8> b_batchnorm8[64], ap_fixed<5, 2> weight_yolo[36][64][1][1], ap_fixed<11, 3> bias_yolo[36], ap_fixed<16, 8> result[1][36][10][20]) {
                ...
                conv2_ra40: for (int ra40 = 0; ra40 < 16; ++ra40) {
                  conv2_ra41: for (int ra41 = 0; ra41 < 3; ++ra41) {
                    conv2_ra42: for (int ra42 = 0; ra42 < 3; ++ra42) {
                      sum_ = ((ap_fixed<16, 8>)(((ap_fixed<17, 9>)(((ap_fixed<10, 6>)((ap_fixed<9, 5>)conv2_window_buffer[0][ra40][ra41][ra42])) * ((ap_fixed<10, 6>)((ap_fixed<9, 6>)weight_conv2[ff1][ra40][ra41][ra42])))) + ((ap_fixed<17, 9>)sum_)));
                    }
                  }
                }
                ...
                conv3_ra45: for (int ra45 = 0; ra45 < 32; ++ra45) {
                  conv3_ra46: for (int ra46 = 0; ra46 < 3; ++ra46) {
                    conv3_ra47: for (int ra47 = 0; ra47 < 3; ++ra47) {
                      sum__ = ((ap_fixed<16, 8>)(((ap_fixed<17, 9>)(((ap_fixed<10, 6>)((ap_fixed<9, 5>)conv3_window_buffer[0][ra45][ra46][ra47])) * ((ap_fixed<10, 6>)((ap_fixed<9, 6>)weight_conv3[ff2][ra45][ra46][ra47])))) + ((ap_fixed<17, 9>)sum__)));
                    }
                  }
                }
                ...
                conv4_ra50: for (int ra50 = 0; ra50 < 64; ++ra50) {
                  conv4_ra51: for (int ra51 = 0; ra51 < 3; ++ra51) {
                    conv4_ra52: for (int ra52 = 0; ra52 < 3; ++ra52) {
                      sum___ = ((ap_fixed<16, 8>)(((ap_fixed<17, 9>)(((ap_fixed<10, 6>)((ap_fixed<9, 5>)conv4_window_buffer[0][ra50][ra51][ra52])) * ((ap_fixed<10, 6>)((ap_fixed<9, 6>)weight_conv4[ff3][ra50][ra51][ra52])))) + ((ap_fixed<17, 9>)sum___)));
                    }
                  }
                }
                ...
                conv5_ra55: for (int ra55 = 0; ra55 < 64; ++ra55) {
                  conv5_ra56: for (int ra56 = 0; ra56 < 3; ++ra56) {
                    conv5_ra57: for (int ra57 = 0; ra57 < 3; ++ra57) {
                      sum____ = ((ap_fixed<16, 8>)(((ap_fixed<17, 9>)(((ap_fixed<10, 6>)((ap_fixed<9, 5>)conv5_window_buffer[0][ra55][ra56][ra57])) * ((ap_fixed<10, 6>)((ap_fixed<9, 6>)weight_conv5[ff4][ra55][ra56][ra57])))) + ((ap_fixed<17, 9>)sum____)));
                    }
                  }
                }
                ...
                conv6_ra58: for (int ra58 = 0; ra58 < 64; ++ra58) {
                  conv6_ra59: for (int ra59 = 0; ra59 < 3; ++ra59) {
                    conv6_ra60: for (int ra60 = 0; ra60 < 3; ++ra60) {
                      sum_____ = ((ap_fixed<16, 8>)(((ap_fixed<17, 9>)(((ap_fixed<10, 6>)((ap_fixed<9, 5>)conv6_window_buffer[0][ra58][ra59][ra60])) * ((ap_fixed<10, 6>)((ap_fixed<9, 6>)weight_conv6[ff5][ra58][ra59][ra60])))) + ((ap_fixed<17, 9>)sum_____)));
                    }
                  }
                }
                ...
                conv7_ra61: for (int ra61 = 0; ra61 < 64; ++ra61) {
                  conv7_ra62: for (int ra62 = 0; ra62 < 3; ++ra62) {
                    conv7_ra63: for (int ra63 = 0; ra63 < 3; ++ra63) {
                      sum______ = ((ap_fixed<16, 8>)(((ap_fixed<17, 9>)(((ap_fixed<10, 6>)((ap_fixed<9, 5>)conv7_window_buffer[0][ra61][ra62][ra63])) * ((ap_fixed<10, 6>)((ap_fixed<9, 6>)weight_conv7[ff6][ra61][ra62][ra63])))) + ((ap_fixed<17, 9>)sum______)));
                    }
                  }
                }
    ...
    conv8_pad_indices11: for (int indices11 = 0; indices11 < 1; ++indices11) {
      conv8_pad_not_zero11: for (int not_zero11 = 0; not_zero11 < 64; ++not_zero11) {
        conv8_pad_index_tuple11: for (int index_tuple11 = 0; index_tuple11 < 12; ++index_tuple11) {
          ...
          #pragma HLS pipeline
            conv8_pad[indices11][not_zero11][index_tuple11][i15] = (((((1 <= index_tuple11) && (index_tuple11 < 11)) && (1 <= i15)) && (i15 < 21)) ? ((ap_ufixed<4, 0>)relu7[((((((i15 - ((i15 + -1) % 20)) + (index_tuple11 * 20)) + (not_zero11 * 200)) + (indices11 * 12800)) + -21) / 12800)][(((((((i15 - ((i15 + -1) % 20)) + (index_tuple11 * 20)) + (not_zero11 * 200)) + (indices11 * 12800)) + -21) / 200) % 64)][(((((((i15 - ((i15 + -1) % 20)) + (index_tuple11 * 20)) + (not_zero11 * 200)) + (indices11 * 12800)) + -21) / 20) % 10)][((i15 + -1) % 20)]) : ((ap_ufixed<4, 0>)0));
          }
        }
      }
    }
                ...
                conv8_ra64: for (int ra64 = 0; ra64 < 64; ++ra64) {
                  conv8_ra65: for (int ra65 = 0; ra65 < 3; ++ra65) {
                    conv8_ra66: for (int ra66 = 0; ra66 < 3; ++ra66) {
                      sum_______ = ((ap_fixed<16, 8>)(((ap_fixed<17, 9>)(((ap_fixed<10, 6>)((ap_fixed<9, 5>)conv8_window_buffer[0][ra64][ra65][ra66])) * ((ap_fixed<10, 6>)((ap_fixed<9, 6>)weight_conv8[ff7][ra64][ra65][ra66])))) + ((ap_fixed<17, 9>)sum_______)));
                    }
                  }
                }
    ...
    ap_ufixed<4, 0> relu8[1][64][10][20];
      ...
      relu8_args07: for (int args07 = 0; args07 < 64; ++args07) {
        relu8_args17: for (int args17 = 0; args17 < 10; ++args17) {
          ...
          #pragma HLS pipeline
            ...
            batch_norm8 = ((ap_fixed<16, 8>)(((ap_fixed<31, 13>)(((ap_fixed<30, 20>)a_batchnorm8[args07]) * ((ap_fixed<30, 22>)conv8[y7][args07][args17][args27]))) + ((ap_fixed<31, 13>)b_batchnorm8[args07])));
            relu8[y7][args07][args17][args27] = ((ap_ufixed<4, 0>)((((ap_fixed<40, 32>)batch_norm8) < (ap_fixed<40, 32>)0) ? (((ap_fixed<16, 8>)0)) : ((ap_fixed<16, 8>)(((ap_fixed<40, 32>)1 < ((ap_fixed<40, 32>)batch_norm8)) ? (((ap_fixed<16, 8>)1)) : ((ap_fixed<16, 8>)batch_norm8)))));
          }
        }
      }
    }
            ...
            yolointermediate_ra67: for (int ra67 = 0; ra67 < 64; ++ra67) {
              yolointermediate_ra68: for (int ra68 = 0; ra68 < 1; ++ra68) {
                yolointermediate_ra69: for (int ra69 = 0; ra69 < 1; ++ra69) {
                  sum________ = ((ap_fixed<16, 8>)(((ap_fixed<17, 9>)(((ap_fixed<9, 5>)relu8[nn8][ra67][(yy + ra68)][(xx + ra69)]) * ((ap_fixed<9, 6>)weight_yolo[ff8][((ra69 + ra68) + ra67)][0][0]))) + ((ap_fixed<17, 9>)sum________)));
                }
              }
            }
    ...
    result_x13: for (int x13 = 0; x13 < 1; ++x13) {
      result_args08: for (int args08 = 0; args08 < 36; ++args08) {
        result_args18: for (int args18 = 0; args18 < 10; ++args18) {
          ...
          #pragma HLS pipeline
            ap_fixed<16, 8> yolo;
            yolo = ((ap_fixed<16, 8>)(((ap_fixed<17, 9>)yolointermediate[x13][args08][args18][args28]) + ((ap_fixed<17, 9>)bias_yolo[args08])));
            result[x13][args08][args18][args28] = yolo;
          }
        }
      }
    }
