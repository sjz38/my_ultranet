...
int main(int argc, char ** argv) {
  ...
  int8_t* arg_0 = (int8_t*)shmat(/*input_image*/884737, nullptr, 0);
  ...
  int8_t* arg_1 = (int8_t*)shmat(/*weight_conv1*/884738, nullptr, 0);
  ...
  int16_t* arg_2 = (int16_t*)shmat(/*a_batchnorm1*/884739, nullptr, 0);
  auto a_batchnorm1 = new ap_int<14>[16];
  for (size_t i0 = 0; i0 < 16; i0++) {
    a_batchnorm1[i0] = (int16_t)(arg_2[i0]) >> 10;
  }

  int32_t* arg_3 = (int32_t*)shmat(/*b_batchnorm1*/884740, nullptr, 0);
  auto b_batchnorm1 = new ap_int<26>[16];
  for (size_t i0 = 0; i0 < 16; i0++) {
    b_batchnorm1[i0] = (int32_t)(arg_3[i0]) >> 18;
  }

  int8_t* arg_4 = (int8_t*)shmat(/*weight_conv2*/884741, nullptr, 0);
  ...
  int16_t* arg_5 = (int16_t*)shmat(/*a_batchnorm2*/884742, nullptr, 0);
  auto a_batchnorm2 = new ap_int<14>[32];
  for (size_t i0 = 0; i0 < 32; i0++) {
    a_batchnorm2[i0] = (int16_t)(arg_5[i0]) >> 10;
  }

  int32_t* arg_6 = (int32_t*)shmat(/*b_batchnorm2*/884743, nullptr, 0);
  auto b_batchnorm2 = new ap_int<26>[32];
  for (size_t i0 = 0; i0 < 32; i0++) {
    b_batchnorm2[i0] = (int32_t)(arg_6[i0]) >> 18;
  }

  int8_t* arg_7 = (int8_t*)shmat(/*weight_conv3*/884744, nullptr, 0);
  ...
  int16_t* arg_8 = (int16_t*)shmat(/*a_batchnorm3*/884745, nullptr, 0);
  auto a_batchnorm3 = new ap_int<14>[64];
  for (size_t i0 = 0; i0 < 64; i0++) {
    a_batchnorm3[i0] = (int16_t)(arg_8[i0]) >> 10;
  }

  int32_t* arg_9 = (int32_t*)shmat(/*b_batchnorm3*/884746, nullptr, 0);
  auto b_batchnorm3 = new ap_int<26>[64];
  for (size_t i0 = 0; i0 < 64; i0++) {
    b_batchnorm3[i0] = (int32_t)(arg_9[i0]) >> 18;
  }

  int8_t* arg_10 = (int8_t*)shmat(/*weight_conv4*/884747, nullptr, 0);
  ...
  int16_t* arg_11 = (int16_t*)shmat(/*a_batchnorm4*/884748, nullptr, 0);
  auto a_batchnorm4 = new ap_int<14>[64];
  for (size_t i0 = 0; i0 < 64; i0++) {
    a_batchnorm4[i0] = (int16_t)(arg_11[i0]) >> 10;
  }

  int32_t* arg_12 = (int32_t*)shmat(/*b_batchnorm4*/884749, nullptr, 0);
  auto b_batchnorm4 = new ap_int<26>[64];
  for (size_t i0 = 0; i0 < 64; i0++) {
    b_batchnorm4[i0] = (int32_t)(arg_12[i0]) >> 18;
  }

  int8_t* arg_13 = (int8_t*)shmat(/*weight_conv5*/884750, nullptr, 0);
  ...
  int16_t* arg_14 = (int16_t*)shmat(/*a_batchnorm5*/884751, nullptr, 0);
  auto a_batchnorm5 = new ap_int<14>[64];
  for (size_t i0 = 0; i0 < 64; i0++) {
    a_batchnorm5[i0] = (int16_t)(arg_14[i0]) >> 10;
  }

  int32_t* arg_15 = (int32_t*)shmat(/*b_batchnorm5*/884752, nullptr, 0);
  auto b_batchnorm5 = new ap_int<26>[64];
  for (size_t i0 = 0; i0 < 64; i0++) {
    b_batchnorm5[i0] = (int32_t)(arg_15[i0]) >> 18;
  }

  int8_t* arg_16 = (int8_t*)shmat(/*weight_conv6*/884753, nullptr, 0);
  ...
  int16_t* arg_17 = (int16_t*)shmat(/*a_batchnorm6*/884754, nullptr, 0);
  auto a_batchnorm6 = new ap_int<14>[64];
  for (size_t i0 = 0; i0 < 64; i0++) {
    a_batchnorm6[i0] = (int16_t)(arg_17[i0]) >> 10;
  }

  int32_t* arg_18 = (int32_t*)shmat(/*b_batchnorm6*/884755, nullptr, 0);
  auto b_batchnorm6 = new ap_int<26>[64];
  for (size_t i0 = 0; i0 < 64; i0++) {
    b_batchnorm6[i0] = (int32_t)(arg_18[i0]) >> 18;
  }

  int8_t* arg_19 = (int8_t*)shmat(/*weight_conv7*/884756, nullptr, 0);
  ...
  int16_t* arg_20 = (int16_t*)shmat(/*a_batchnorm7*/884757, nullptr, 0);
  auto a_batchnorm7 = new ap_int<14>[64];
  for (size_t i0 = 0; i0 < 64; i0++) {
    a_batchnorm7[i0] = (int16_t)(arg_20[i0]) >> 10;
  }

  int32_t* arg_21 = (int32_t*)shmat(/*b_batchnorm7*/884758, nullptr, 0);
  auto b_batchnorm7 = new ap_int<26>[64];
  for (size_t i0 = 0; i0 < 64; i0++) {
    b_batchnorm7[i0] = (int32_t)(arg_21[i0]) >> 18;
  }

  int8_t* arg_22 = (int8_t*)shmat(/*weight_conv8*/884759, nullptr, 0);
  ...
  int16_t* arg_23 = (int16_t*)shmat(/*a_batchnorm8*/884760, nullptr, 0);
  auto a_batchnorm8 = new ap_int<14>[64];
  for (size_t i0 = 0; i0 < 64; i0++) {
    a_batchnorm8[i0] = (int16_t)(arg_23[i0]) >> 10;
  }

  int32_t* arg_24 = (int32_t*)shmat(/*b_batchnorm8*/884761, nullptr, 0);
  auto b_batchnorm8 = new ap_int<26>[64];
  for (size_t i0 = 0; i0 < 64; i0++) {
    b_batchnorm8[i0] = (int32_t)(arg_24[i0]) >> 18;
  }

  int8_t* arg_25 = (int8_t*)shmat(/*weight_yolo*/884762, nullptr, 0);
  ...
  int16_t* arg_26 = (int16_t*)shmat(/*bias_yolo*/884763, nullptr, 0);
  auto bias_yolo = new ap_int<11>[36];
  for (size_t i0 = 0; i0 < 36; i0++) {
    bias_yolo[i0] = (int16_t)(arg_26[i0]) >> 8;
  }

  int16_t* arg_27 = (int16_t*)shmat(/*result*/884764, nullptr, 0);
