...
// ==============================================================
#ifndef __test_mul_mul_21nsgMb__HH__
#define __test_mul_mul_21nsgMb__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(test_mul_mul_21nsgMb) {
    ...
    SC_CTOR(test_mul_mul_21nsgMb):  ACMP_smul_us_U ("ACMP_smul_us_U") {
