...
// ==============================================================
#ifndef __test_mac_muladd_5gXb__HH__
#define __test_mac_muladd_5gXb__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(test_mac_muladd_5gXb) {
    ...
    SC_CTOR(test_mac_muladd_5gXb):  simcore_mac_10_U ("simcore_mac_10_U") {
