...
// ==============================================================
#ifndef __test_mac_muladd_8g3b__HH__
#define __test_mac_muladd_8g3b__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(test_mac_muladd_8g3b) {
    ...
    SC_CTOR(test_mac_muladd_8g3b):  simcore_mac_0_U ("simcore_mac_0_U") {
