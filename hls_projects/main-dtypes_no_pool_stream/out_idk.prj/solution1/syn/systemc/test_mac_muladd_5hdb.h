...
// ==============================================================
#ifndef __test_mac_muladd_5hdb__HH__
#define __test_mac_muladd_5hdb__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(test_mac_muladd_5hdb) {
    ...
    SC_CTOR(test_mac_muladd_5hdb):  simcore_mac_10_U ("simcore_mac_10_U") {
