...
// ==============================================================
#ifndef __test_mac_muladd_7g7b__HH__
#define __test_mac_muladd_7g7b__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(test_mac_muladd_7g7b) {
    ...
    SC_CTOR(test_mac_muladd_7g7b):  simcore_mac_4_U ("simcore_mac_4_U") {
