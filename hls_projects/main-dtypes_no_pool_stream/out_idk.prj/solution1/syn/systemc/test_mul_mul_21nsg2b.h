...
// ==============================================================
#ifndef __test_mul_mul_21nsg2b__HH__
#define __test_mul_mul_21nsg2b__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(test_mul_mul_21nsg2b) {
    ...
    SC_CTOR(test_mul_mul_21nsg2b):  ACMP_smul_us_U ("ACMP_smul_us_U") {
