...
// ==============================================================
#ifndef __test_mac_muladd_6hbb__HH__
#define __test_mac_muladd_6hbb__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(test_mac_muladd_6hbb) {
    ...
    SC_CTOR(test_mac_muladd_6hbb):  simcore_mac_8_U ("simcore_mac_8_U") {
