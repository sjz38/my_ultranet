...
// ==============================================================
#ifndef __test_mac_muladd_6hab__HH__
#define __test_mac_muladd_6hab__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(test_mac_muladd_6hab) {
    ...
    SC_CTOR(test_mac_muladd_6hab):  simcore_mac_7_U ("simcore_mac_7_U") {
