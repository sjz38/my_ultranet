...
// ==============================================================
#ifndef __test_mac_muladd_5gWb__HH__
#define __test_mac_muladd_5gWb__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(test_mac_muladd_5gWb) {
    ...
    SC_CTOR(test_mac_muladd_5gWb):  simcore_mac_9_U ("simcore_mac_9_U") {
