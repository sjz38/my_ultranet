...
// ==============================================================
#ifndef __test_mul_mul_12nsmIc__HH__
#define __test_mul_mul_12nsmIc__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(test_mul_mul_12nsmIc) {
    ...
    SC_CTOR(test_mul_mul_12nsmIc):  ACMP_smul_uu_U ("ACMP_smul_uu_U") {
