...
// ==============================================================
#ifndef __test_fpext_32ns_6mrb__HH__
#define __test_fpext_32ns_6mrb__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(test_fpext_32ns_6mrb) {
    ...
    SC_CTOR(test_fpext_32ns_6mrb):  ACMP_fpext_U ("ACMP_fpext_U") {
