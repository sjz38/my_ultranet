...
// ==============================================================
#ifndef __test_mac_muladd_5mCc__HH__
#define __test_mac_muladd_5mCc__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(test_mac_muladd_5mCc) {
    ...
    SC_CTOR(test_mac_muladd_5mCc):  simcore_mac_5_U ("simcore_mac_5_U") {
