...
// ==============================================================
#ifndef __test_mul_mul_10nsmwb__HH__
#define __test_mul_mul_10nsmwb__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(test_mul_mul_10nsmwb) {
    ...
    SC_CTOR(test_mul_mul_10nsmwb):  ACMP_smul_uu_U ("ACMP_smul_uu_U") {
