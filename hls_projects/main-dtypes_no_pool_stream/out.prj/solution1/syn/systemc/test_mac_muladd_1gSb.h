...
// ==============================================================
#ifndef __test_mac_muladd_1gSb__HH__
#define __test_mac_muladd_1gSb__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(test_mac_muladd_1gSb) {
    ...
    SC_CTOR(test_mac_muladd_1gSb):  simcore_mac_2_U ("simcore_mac_2_U") {
