...
// ==============================================================
#ifndef __test_mac_muladd_4g1b__HH__
#define __test_mac_muladd_4g1b__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(test_mac_muladd_4g1b) {
    ...
    SC_CTOR(test_mac_muladd_4g1b):  simcore_mac_11_U ("simcore_mac_11_U") {
