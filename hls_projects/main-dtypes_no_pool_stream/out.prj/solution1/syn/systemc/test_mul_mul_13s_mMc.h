...
// ==============================================================
#ifndef __test_mul_mul_13s_mMc__HH__
#define __test_mul_mul_13s_mMc__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(test_mul_mul_13s_mMc) {
    ...
    SC_CTOR(test_mul_mul_13s_mMc):  ACMP_smul_su_U ("ACMP_smul_su_U") {
