...
// ==============================================================
#ifndef __test_mac_muladd_5rtc__HH__
#define __test_mac_muladd_5rtc__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(test_mac_muladd_5rtc) {
    ...
    SC_CTOR(test_mac_muladd_5rtc):  simcore_mac_4_U ("simcore_mac_4_U") {
