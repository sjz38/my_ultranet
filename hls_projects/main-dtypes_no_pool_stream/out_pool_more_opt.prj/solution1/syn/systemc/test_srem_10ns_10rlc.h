...
// ==============================================================
#ifndef __test_srem_10ns_10rlc__HH__
#define __test_srem_10ns_10rlc__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(test_srem_10ns_10rlc) {
    ...
    ACMP_srem_seq<ID, 14, din0_WIDTH, din1_WIDTH, dout_WIDTH> ACMP_srem_seq_U;

    SC_CTOR(test_srem_10ns_10rlc):  ACMP_srem_seq_U ("ACMP_srem_seq_U") {
