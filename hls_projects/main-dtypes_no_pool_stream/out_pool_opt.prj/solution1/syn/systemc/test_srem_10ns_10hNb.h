...
// ==============================================================
#ifndef __test_srem_10ns_10hNb__HH__
#define __test_srem_10ns_10hNb__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(test_srem_10ns_10hNb) {
    ...
    SC_CTOR(test_srem_10ns_10hNb):  ACMP_srem_seq_U ("ACMP_srem_seq_U") {
