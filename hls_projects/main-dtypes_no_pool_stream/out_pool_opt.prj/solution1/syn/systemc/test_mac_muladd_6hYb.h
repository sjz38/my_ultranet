...
// ==============================================================
#ifndef __test_mac_muladd_6hYb__HH__
#define __test_mac_muladd_6hYb__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(test_mac_muladd_6hYb) {
    ...
    SC_CTOR(test_mac_muladd_6hYb):  simcore_mac_7_U ("simcore_mac_7_U") {
