...
// ==============================================================
#ifndef __test_mac_muladd_1hTb__HH__
#define __test_mac_muladd_1hTb__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(test_mac_muladd_1hTb) {
    ...
    SC_CTOR(test_mac_muladd_1hTb):  simcore_mac_2_U ("simcore_mac_2_U") {
