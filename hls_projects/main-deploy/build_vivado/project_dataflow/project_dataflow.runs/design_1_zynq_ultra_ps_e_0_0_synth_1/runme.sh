...
HD_PWD='/work/shared/users/meng/sjz38/tmp/my_ultranet/hls_projects/main-deploy/build_vivado/project_dataflow/project_dataflow.runs/design_1_zynq_ultra_ps_e_0_0_synth_1'
cd "$HD_PWD"
