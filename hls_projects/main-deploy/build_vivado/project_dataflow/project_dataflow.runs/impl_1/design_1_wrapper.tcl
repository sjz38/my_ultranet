...
set rc [catch {
  ...
  add_files -quiet /work/shared/users/meng/sjz38/tmp/my_ultranet/hls_projects/main-deploy/build_vivado/project_dataflow/project_dataflow.runs/synth_1/design_1_wrapper.dcp
