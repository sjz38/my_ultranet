...
`define AUTOTB_TVIN_gmem_out_wrapc  "../tv/rtldatafile/rtl.test.autotvin_gmem.dat"
`define AUTOTB_TVIN_input_image_out_wrapc  "../tv/rtldatafile/rtl.test.autotvin_input_image.dat"
`define AUTOTB_TVIN_result_out_wrapc  "../tv/rtldatafile/rtl.test.autotvin_result.dat"
`define AUTOTB_TVOUT_gmem  "../tv/cdatafile/c.test.autotvout_gmem.dat"
`define AUTOTB_TVOUT_gmem_out_wrapc  "../tv/rtldatafile/rtl.test.autotvout_gmem.dat"
module `AUTOTB_TOP;
