...
`define AESL_DEPTH_input_image 1
`define AESL_DEPTH_result 1
`define AUTOTB_TVIN_gmem  "./c.test.autotvin_gmem.dat"
`define AUTOTB_TVIN_input_image  "./c.test.autotvin_input_image.dat"
`define AUTOTB_TVIN_result  "./c.test.autotvin_result.dat"
`define AUTOTB_TVIN_gmem_out_wrapc  "./rtl.test.autotvin_gmem.dat"
`define AUTOTB_TVIN_input_image_out_wrapc  "./rtl.test.autotvin_input_image.dat"
`define AUTOTB_TVIN_result_out_wrapc  "./rtl.test.autotvin_result.dat"
`define AUTOTB_TVOUT_gmem  "./c.test.autotvout_gmem.dat"
`define AUTOTB_TVOUT_gmem_out_wrapc  "./impl_rtl.test.autotvout_gmem.dat"
module `AUTOTB_TOP;

parameter AUTOTB_TRANSACTION_NUM = 1;
parameter PROGRESS_TIMEOUT = 10000000;
parameter LATENCY_ESTIMATION = 4348112;
parameter LENGTH_gmem = 166400;
parameter LENGTH_input_image = 1;
...
AESL_axi_master_gmem AESL_AXI_MASTER_gmem(
    ...
    .TRAN_gmem_input_image (input_image),
    .TRAN_gmem_result (result),
