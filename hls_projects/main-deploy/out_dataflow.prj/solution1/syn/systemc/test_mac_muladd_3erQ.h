...
// ==============================================================
#ifndef __test_mac_muladd_3erQ__HH__
#define __test_mac_muladd_3erQ__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(test_mac_muladd_3erQ) {
    ...
    SC_CTOR(test_mac_muladd_3erQ):  simcore_mac_11_U ("simcore_mac_11_U") {
