...
// ==============================================================
#ifndef __test_mul_mul_20nsXh4__HH__
#define __test_mul_mul_20nsXh4__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(test_mul_mul_20nsXh4) {
    ...
    SC_CTOR(test_mul_mul_20nsXh4):  ACMP_smul_us_U ("ACMP_smul_us_U") {
