...
// ==============================================================
#ifndef __test_mac_muladd_5emP__HH__
#define __test_mac_muladd_5emP__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(test_mac_muladd_5emP) {
    ...
    SC_CTOR(test_mac_muladd_5emP):  simcore_mac_6_U ("simcore_mac_6_U") {
