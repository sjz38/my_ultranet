...
// ==============================================================
#ifndef __test_mac_muladd_5eoQ__HH__
#define __test_mac_muladd_5eoQ__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(test_mac_muladd_5eoQ) {
    ...
    SC_CTOR(test_mac_muladd_5eoQ):  simcore_mac_8_U ("simcore_mac_8_U") {
