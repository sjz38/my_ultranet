...
// ==============================================================
#ifndef __test_mac_muladd_5kTb__HH__
#define __test_mac_muladd_5kTb__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(test_mac_muladd_5kTb) {
    ...
    SC_CTOR(test_mac_muladd_5kTb):  simcore_mac_15_U ("simcore_mac_15_U") {
