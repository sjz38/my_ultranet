...
// ==============================================================
#ifndef __test_fpext_32ns_6UhA__HH__
#define __test_fpext_32ns_6UhA__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(test_fpext_32ns_6UhA) {
    ...
    SC_CTOR(test_fpext_32ns_6UhA):  ACMP_fpext_U ("ACMP_fpext_U") {
