...
// ==============================================================
#ifndef __test_mac_muladd_6soc__HH__
#define __test_mac_muladd_6soc__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(test_mac_muladd_6soc) {
    ...
    SC_CTOR(test_mac_muladd_6soc):  simcore_mac_7_U ("simcore_mac_7_U") {
