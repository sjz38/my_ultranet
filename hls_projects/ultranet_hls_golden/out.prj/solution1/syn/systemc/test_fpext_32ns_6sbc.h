...
// ==============================================================
#ifndef __test_fpext_32ns_6sbc__HH__
#define __test_fpext_32ns_6sbc__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(test_fpext_32ns_6sbc) {
    ...
    SC_CTOR(test_fpext_32ns_6sbc):  ACMP_fpext_U ("ACMP_fpext_U") {
