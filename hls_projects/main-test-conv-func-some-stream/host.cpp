...
int main(int argc, char ** argv) {
  ...
  int8_t* arg_0 = (int8_t*)shmat(/*input_image*/1376259, nullptr, 0);
  ...
  int8_t* arg_1 = (int8_t*)shmat(/*weight_conv1*/1376260, nullptr, 0);
  ...
  int16_t* arg_2 = (int16_t*)shmat(/*a_batchnorm1*/1376261, nullptr, 0);
  auto a_batchnorm1 = new ap_int<14>[16];
  for (size_t i0 = 0; i0 < 16; i0++) {
    a_batchnorm1[i0] = (int16_t)(arg_2[i0]) >> 10;
  }

  int32_t* arg_3 = (int32_t*)shmat(/*b_batchnorm1*/1376262, nullptr, 0);
  auto b_batchnorm1 = new ap_int<26>[16];
  for (size_t i0 = 0; i0 < 16; i0++) {
    b_batchnorm1[i0] = (int32_t)(arg_3[i0]) >> 18;
  }

  int8_t* arg_4 = (int8_t*)shmat(/*weight_conv2*/1376263, nullptr, 0);
  ...
  int16_t* arg_5 = (int16_t*)shmat(/*a_batchnorm2*/1376264, nullptr, 0);
  auto a_batchnorm2 = new ap_int<14>[32];
  for (size_t i0 = 0; i0 < 32; i0++) {
    a_batchnorm2[i0] = (int16_t)(arg_5[i0]) >> 10;
  }

  int32_t* arg_6 = (int32_t*)shmat(/*b_batchnorm2*/1376265, nullptr, 0);
  auto b_batchnorm2 = new ap_int<26>[32];
  for (size_t i0 = 0; i0 < 32; i0++) {
    b_batchnorm2[i0] = (int32_t)(arg_6[i0]) >> 18;
  }

  int8_t* arg_7 = (int8_t*)shmat(/*weight_conv3*/1376266, nullptr, 0);
  ...
  int16_t* arg_8 = (int16_t*)shmat(/*a_batchnorm3*/1376267, nullptr, 0);
  auto a_batchnorm3 = new ap_int<14>[64];
  for (size_t i0 = 0; i0 < 64; i0++) {
    a_batchnorm3[i0] = (int16_t)(arg_8[i0]) >> 10;
  }

  int32_t* arg_9 = (int32_t*)shmat(/*b_batchnorm3*/1376268, nullptr, 0);
  auto b_batchnorm3 = new ap_int<26>[64];
  for (size_t i0 = 0; i0 < 64; i0++) {
    b_batchnorm3[i0] = (int32_t)(arg_9[i0]) >> 18;
  }

  int8_t* arg_10 = (int8_t*)shmat(/*weight_conv4*/1376269, nullptr, 0);
  ...
  int16_t* arg_11 = (int16_t*)shmat(/*a_batchnorm4*/1376270, nullptr, 0);
  auto a_batchnorm4 = new ap_int<14>[64];
  for (size_t i0 = 0; i0 < 64; i0++) {
    a_batchnorm4[i0] = (int16_t)(arg_11[i0]) >> 10;
  }

  int32_t* arg_12 = (int32_t*)shmat(/*b_batchnorm4*/1376271, nullptr, 0);
  auto b_batchnorm4 = new ap_int<26>[64];
  for (size_t i0 = 0; i0 < 64; i0++) {
    b_batchnorm4[i0] = (int32_t)(arg_12[i0]) >> 18;
  }

  int8_t* arg_13 = (int8_t*)shmat(/*weight_conv5*/1376272, nullptr, 0);
  ...
  int16_t* arg_14 = (int16_t*)shmat(/*a_batchnorm5*/1376273, nullptr, 0);
  auto a_batchnorm5 = new ap_int<14>[64];
  for (size_t i0 = 0; i0 < 64; i0++) {
    a_batchnorm5[i0] = (int16_t)(arg_14[i0]) >> 10;
  }

  int32_t* arg_15 = (int32_t*)shmat(/*b_batchnorm5*/1376274, nullptr, 0);
  auto b_batchnorm5 = new ap_int<26>[64];
  for (size_t i0 = 0; i0 < 64; i0++) {
    b_batchnorm5[i0] = (int32_t)(arg_15[i0]) >> 18;
  }

  int8_t* arg_16 = (int8_t*)shmat(/*weight_conv6*/1376275, nullptr, 0);
  ...
  int16_t* arg_17 = (int16_t*)shmat(/*a_batchnorm6*/1376276, nullptr, 0);
  auto a_batchnorm6 = new ap_int<14>[64];
  for (size_t i0 = 0; i0 < 64; i0++) {
    a_batchnorm6[i0] = (int16_t)(arg_17[i0]) >> 10;
  }

  int32_t* arg_18 = (int32_t*)shmat(/*b_batchnorm6*/1376277, nullptr, 0);
  auto b_batchnorm6 = new ap_int<26>[64];
  for (size_t i0 = 0; i0 < 64; i0++) {
    b_batchnorm6[i0] = (int32_t)(arg_18[i0]) >> 18;
  }

  int8_t* arg_19 = (int8_t*)shmat(/*weight_conv7*/1376278, nullptr, 0);
  ...
  int16_t* arg_20 = (int16_t*)shmat(/*a_batchnorm7*/1376279, nullptr, 0);
  auto a_batchnorm7 = new ap_int<14>[64];
  for (size_t i0 = 0; i0 < 64; i0++) {
    a_batchnorm7[i0] = (int16_t)(arg_20[i0]) >> 10;
  }

  int32_t* arg_21 = (int32_t*)shmat(/*b_batchnorm7*/1376280, nullptr, 0);
  auto b_batchnorm7 = new ap_int<26>[64];
  for (size_t i0 = 0; i0 < 64; i0++) {
    b_batchnorm7[i0] = (int32_t)(arg_21[i0]) >> 18;
  }

  int8_t* arg_22 = (int8_t*)shmat(/*weight_conv8*/1376281, nullptr, 0);
  ...
  int16_t* arg_23 = (int16_t*)shmat(/*a_batchnorm8*/1376282, nullptr, 0);
  auto a_batchnorm8 = new ap_int<14>[64];
  for (size_t i0 = 0; i0 < 64; i0++) {
    a_batchnorm8[i0] = (int16_t)(arg_23[i0]) >> 10;
  }

  int32_t* arg_24 = (int32_t*)shmat(/*b_batchnorm8*/1376283, nullptr, 0);
  auto b_batchnorm8 = new ap_int<26>[64];
  for (size_t i0 = 0; i0 < 64; i0++) {
    b_batchnorm8[i0] = (int32_t)(arg_24[i0]) >> 18;
  }

  int16_t* arg_25 = (int16_t*)shmat(/*result*/1376284, nullptr, 0);
