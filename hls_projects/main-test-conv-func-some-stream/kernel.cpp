...
// Use the largest dimension for inputs
// Create single array that each reads and writes to
// Can use stream but pass in shape of element (maybe)
// Use streaming for non-conv layers
void convolution(ap_fixed<5, 2> weight_conv[64][64][3][3], 
                 ap_ufixed<4, 0> conv_pad[1][64][162][322], int conv_pad_d2, int conv_pad_d3, int conv_pad_d4,
                 ap_fixed<16,8> conv[1][64][160][320], int conv_d2, int conv_d3, int conv_d4, 
                 ap_ufixed<4, 0> conv_line_buffer[1][64][3][322], int conv_lb_d2, int conv_lb_d3, int conv_lb_d4,
                 ap_ufixed<4, 0> conv_window_buffer[1][64][3][3], int conv_wb_d2, int conv_wb_d3, int conv_wb_d4){
    conv_nn: for (int nn = 0; nn < 1; ++nn) {
      conv_ff: for (int ff = 0; ff < conv_d2; ++ff) {
        conv_yy_reuse: for (int yy_reuse = 0; yy_reuse < conv_pad_d3; ++yy_reuse) {
          conv_xx_reuse: for (int xx_reuse = 0; xx_reuse < conv_pad_d4; ++xx_reuse) {
          // #pragma HLS pipeline
            conv_pad_2: for (int conv_pad_2 = 0; conv_pad_2 < conv_lb_d2; ++conv_pad_2) {
              #pragma HLS pipeline
              conv_pad_1: for (int conv_pad_1 = 0; conv_pad_1 < 2; ++conv_pad_1) {
                conv_line_buffer[0][conv_pad_2][conv_pad_1][xx_reuse] = conv_line_buffer[0][conv_pad_2][(conv_pad_1 + 1)][xx_reuse];
              }
              conv_line_buffer[0][conv_pad_2][2][xx_reuse] = conv_pad[nn][conv_pad_2][yy_reuse][xx_reuse];
            }
            if (2 <= yy_reuse) {
              conv_line_buffer_1: for (int conv_line_buffer_1 = 0; conv_line_buffer_1 < conv_lb_d3; ++conv_line_buffer_1) {
                conv_line_buffer_2: for (int conv_line_buffer_2 = 0; conv_line_buffer_2 < conv_lb_d2; ++conv_line_buffer_2) {
                  conv_line_buffer_0: for (int conv_line_buffer_0 = 0; conv_line_buffer_0 < 2; ++conv_line_buffer_0) {
                    conv_window_buffer[0][conv_line_buffer_2][conv_line_buffer_1][conv_line_buffer_0] = conv_window_buffer[0][conv_line_buffer_2][conv_line_buffer_1][(conv_line_buffer_0 + 1)];
                  }
                  conv_window_buffer[0][conv_line_buffer_2][conv_line_buffer_1][2] = conv_line_buffer[0][conv_line_buffer_2][conv_line_buffer_1][xx_reuse];
                }
              }
              if (2 <= xx_reuse) {
                ap_fixed<16, 8> sum;
                ...
                conv_ra52: for (int ra52 = 0; ra52 < conv_wb_d2; ++ra52) {
                  conv_ra53: for (int ra53 = 0; ra53 < conv_wb_d3; ++ra53) {
                    conv_ra54: for (int ra54 = 0; ra54 < conv_wb_d4; ++ra54) {
                      sum = ((ap_fixed<16, 8>)(((ap_fixed<17, 9>)(((ap_fixed<10, 6>)((ap_fixed<9, 5>)conv_window_buffer[0][ra52][ra53][ra54])) * ((ap_fixed<10, 6>)((ap_fixed<9, 6>)weight_conv[ff][ra52][ra53][ra54])))) + ((ap_fixed<17, 9>)sum)));
                    }
                  }
                }
                conv[nn][ff][(yy_reuse + -2)][(xx_reuse + -2)] = sum;
              }
            }
          }
        }
...
void test(ap_fixed<8, 4> input_image[1][3][160][320], ap_fixed<5, 2> weight_conv1[16][3][3][3], ap_fixed<14, 4> a_batchnorm1[16], ap_fixed<26, 8> b_batchnorm1[16], ap_fixed<5, 2> weight_conv2[32][16][3][3], ap_fixed<14, 4> a_batchnorm2[32], ap_fixed<26, 8> b_batchnorm2[32], ap_fixed<5, 2> weight_conv3[64][32][3][3], ap_fixed<14, 4> a_batchnorm3[64], ap_fixed<26, 8> b_batchnorm3[64], ap_fixed<5, 2> weight_conv4[64][64][3][3], ap_fixed<14, 4> a_batchnorm4[64], ap_fixed<26, 8> b_batchnorm4[64], ap_fixed<5, 2> weight_conv5[64][64][3][3], ap_fixed<14, 4> a_batchnorm5[64], ap_fixed<26, 8> b_batchnorm5[64], ap_fixed<5, 2> weight_conv6[64][64][3][3], ap_fixed<14, 4> a_batchnorm6[64], ap_fixed<26, 8> b_batchnorm6[64], ap_fixed<5, 2> weight_conv7[64][64][3][3], ap_fixed<14, 4> a_batchnorm7[64], ap_fixed<26, 8> b_batchnorm7[64], ap_fixed<5, 2> weight_conv8[64][64][3][3], ap_fixed<14, 4> a_batchnorm8[64], ap_fixed<26, 8> b_batchnorm8[64], ap_fixed<16, 8> result[1][64][10][20]) {
    ...
    // Create main buffers for convolution to be used on all layers
    ap_ufixed<4, 0> conv_pad_buf[1][64][162][322];
    #pragma HLS array_partition variable=conv_pad_buf complete dim=2
    ap_fixed<16, 8> conv_buf[1][64][160][320];
    ap_ufixed<4, 0> conv_line_buffer_buf[1][64][3][322];
    #pragma HLS array_partition variable=conv_line_buffer_buf complete dim=3
    ap_ufixed<4, 0> conv_window_buffer_buf[1][64][3][3];    
    #pragma HLS array_partition variable=conv_window_buffer_buf complete dim=3
    #pragma HLS array_partition variable=conv_window_buffer_buf complete dim=4  
    ...
    #pragma HLS array_partition variable=conv1_line_buffer complete dim=3
    ...
    #pragma HLS array_partition variable=conv1_window_buffer complete dim=4
                ...
                conv1_ra32: for (int ra32 = 0; ra32 < 3; ++ra32) {
                  conv1_ra33: for (int ra33 = 0; ra33 < 3; ++ra33) {
                    conv1_ra34: for (int ra34 = 0; ra34 < 3; ++ra34) {
                      sum = ((ap_fixed<16, 8>)(((ap_fixed<17, 9>)(((ap_fixed<14, 10>)((ap_fixed<13, 9>)conv1_window_buffer[0][ra32][ra33][ra34])) * ((ap_fixed<14, 10>)((ap_fixed<13, 10>)weight_conv1[ff][ra32][ra33][ra34])))) + ((ap_fixed<17, 9>)sum)));
                    }
                  }
                }
    ...
    #pragma HLS dataflow
    hls::stream<ap_ufixed<4, 0> > relu1_pipe_1;
    #pragma HLS stream variable=relu1_pipe_1 depth=128
      ...
      relu1_args0: for (int args0 = 0; args0 < 16; ++args0) {
        relu1_args1: for (int args1 = 0; args1 < 160; ++args1) {
          ...
          #pragma HLS pipeline
            ...
            batch_norm1 = ((ap_fixed<16, 8>)(((ap_fixed<31, 13>)(((ap_fixed<30, 20>)a_batchnorm1[args0]) * ((ap_fixed<30, 22>)conv1[y][args0][args1][args2]))) + ((ap_fixed<31, 13>)b_batchnorm1[args0])));
            ...
            relu1_pipe_1.write(relu1_temp);
          }
        }
      }
    }
    ap_ufixed<4, 0> pool1_pad[1][16][160][320];
    hls::stream<ap_ufixed<4, 0> > pool1_pad_pipe_2;
    #pragma HLS stream variable=pool1_pad_pipe_2 depth=128
      ...
      pool1_pad_not_zero1: for (int not_zero1 = 0; not_zero1 < 16; ++not_zero1) {
        pool1_pad_index_tuple1: for (int index_tuple1 = 0; index_tuple1 < 160; ++index_tuple1) {
          ...
          #pragma HLS pipeline
            ...
            relu1_temp1 = relu1_pipe_1.read();
            ap_ufixed<4, 0> pool1_pad_temp;
            pool1_pad_temp = relu1_temp1;
            pool1_pad_pipe_2.write(pool1_pad_temp);
          }
        }
      }
    }
    ap_ufixed<4, 0> pool1[1][16][80][160];
    hls::stream<ap_ufixed<4, 0> > pool1_pipe_3;
    #pragma HLS stream variable=pool1_pipe_3 depth=128
          ...
          #pragma HLS pipeline
            ...
            pool1_ra35: for (int ra35 = 0; ra35 < 2; ++ra35) {
              pool1_ra36: for (int ra36 = 0; ra36 < 2; ++ra36) {
                ...
                pool1_pad_temp1 = pool1_pad_pipe_2.read();
                reducer4 = hls::max(pool1_pad_temp1, reducer4);
              }
            }
            ap_ufixed<4, 0> pool1_temp;
            pool1_temp = reducer4;
            pool1_pipe_3.write(pool1_temp);
          }
        }
      }
    }
    ...
    #pragma HLS array_partition variable=conv2_line_buffer complete dim=3
    ...
    #pragma HLS array_partition variable=conv2_window_buffer complete dim=4
                ...
                conv2_ra37: for (int ra37 = 0; ra37 < 16; ++ra37) {
                  conv2_ra38: for (int ra38 = 0; ra38 < 3; ++ra38) {
                    conv2_ra39: for (int ra39 = 0; ra39 < 3; ++ra39) {
                      sum_ = ((ap_fixed<16, 8>)(((ap_fixed<17, 9>)(((ap_fixed<10, 6>)((ap_fixed<9, 5>)conv2_window_buffer[0][ra37][ra38][ra39])) * ((ap_fixed<10, 6>)((ap_fixed<9, 6>)weight_conv2[ff1][ra37][ra38][ra39])))) + ((ap_fixed<17, 9>)sum_)));
                    }
                  }
                }
    ...
    hls::stream<ap_ufixed<4, 0> > relu2_pipe_4;
      ...
      relu2_args01: for (int args01 = 0; args01 < 32; ++args01) {
        relu2_args11: for (int args11 = 0; args11 < 80; ++args11) {
          ...
          #pragma HLS pipeline
            ...
            batch_norm2 = ((ap_fixed<16, 8>)(((ap_fixed<31, 13>)(((ap_fixed<30, 20>)a_batchnorm2[args01]) * ((ap_fixed<30, 22>)conv2[y1][args01][args11][args21]))) + ((ap_fixed<31, 13>)b_batchnorm2[args01])));
            ...
            relu2_pipe_4.write(relu2_temp);
          }
        }
      }
    }
    ap_ufixed<4, 0> pool2_pad[1][32][80][160];
    hls::stream<ap_ufixed<4, 0> > pool2_pad_pipe_5;
    #pragma HLS stream variable=pool2_pad_pipe_5 depth=128
      ...
      pool2_pad_not_zero3: for (int not_zero3 = 0; not_zero3 < 32; ++not_zero3) {
        pool2_pad_index_tuple3: for (int index_tuple3 = 0; index_tuple3 < 80; ++index_tuple3) {
          ...
          #pragma HLS pipeline
            ...
            relu2_temp1 = relu2_pipe_4.read();
            ap_ufixed<4, 0> pool2_pad_temp;
            pool2_pad_temp = relu2_temp1;
            pool2_pad_pipe_5.write(pool2_pad_temp);
          }
        }
      }
    }
    ap_ufixed<4, 0> pool2[1][32][40][80];
    hls::stream<ap_ufixed<4, 0> > pool2_pipe_6;
    #pragma HLS stream variable=pool2_pipe_6 depth=128
          ...
          #pragma HLS pipeline
            ...
            pool2_ra40: for (int ra40 = 0; ra40 < 2; ++ra40) {
              pool2_ra41: for (int ra41 = 0; ra41 < 2; ++ra41) {
                ...
                pool2_pad_temp1 = pool2_pad_pipe_5.read();
                reducer5 = hls::max(pool2_pad_temp1, reducer5);
              }
            }
            ap_ufixed<4, 0> pool2_temp;
            pool2_temp = reducer5;
            pool2_pipe_6.write(pool2_temp);
          }
        }
      }
    }
    ...
    #pragma HLS array_partition variable=conv3_line_buffer complete dim=3    
    ap_ufixed<4, 0> conv3_window_buffer[1][32][3][3];
    #pragma HLS array_partition variable=conv3_window_buffer complete dim=3
    #pragma HLS array_partition variable=conv3_window_buffer complete dim=4
                ...
                conv3_ra42: for (int ra42 = 0; ra42 < 32; ++ra42) {
                  conv3_ra43: for (int ra43 = 0; ra43 < 3; ++ra43) {
                    conv3_ra44: for (int ra44 = 0; ra44 < 3; ++ra44) {
                      sum__ = ((ap_fixed<16, 8>)(((ap_fixed<17, 9>)(((ap_fixed<10, 6>)((ap_fixed<9, 5>)conv3_window_buffer[0][ra42][ra43][ra44])) * ((ap_fixed<10, 6>)((ap_fixed<9, 6>)weight_conv3[ff2][ra42][ra43][ra44])))) + ((ap_fixed<17, 9>)sum__)));
                    }
                  }
                }
    ...
    hls::stream<ap_ufixed<4, 0> > relu3_pipe_7;
    #pragma HLS stream variable=relu3_pipe_7 depth=128
      ...
      relu3_args02: for (int args02 = 0; args02 < 64; ++args02) {
        relu3_args12: for (int args12 = 0; args12 < 40; ++args12) {
          ...
          #pragma HLS pipeline
            ...
            batch_norm3 = ((ap_fixed<16, 8>)(((ap_fixed<31, 13>)(((ap_fixed<30, 20>)a_batchnorm3[args02]) * ((ap_fixed<30, 22>)conv3[y2][args02][args12][args22]))) + ((ap_fixed<31, 13>)b_batchnorm3[args02])));
            ...
            relu3_pipe_7.write(relu3_temp);
          }
        }
      }
    }
    ap_ufixed<4, 0> pool3_pad[1][64][40][80];
    hls::stream<ap_ufixed<4, 0> > pool3_pad_pipe_8;
    #pragma HLS stream variable=pool3_pad_pipe_8 depth=128
      ...
      pool3_pad_not_zero5: for (int not_zero5 = 0; not_zero5 < 64; ++not_zero5) {
        pool3_pad_index_tuple5: for (int index_tuple5 = 0; index_tuple5 < 40; ++index_tuple5) {
          ...
          #pragma HLS pipeline
            ...
            relu3_temp1 = relu3_pipe_7.read();
            ap_ufixed<4, 0> pool3_pad_temp;
            pool3_pad_temp = relu3_temp1;
            pool3_pad_pipe_8.write(pool3_pad_temp);
          }
        }
      }
    }
    ap_ufixed<4, 0> pool3[1][64][20][40];
    hls::stream<ap_ufixed<4, 0> > pool3_pipe_9;
    #pragma HLS stream variable=pool3_pipe_9 depth=128
          ...
          #pragma HLS pipeline
            ...
            pool3_ra45: for (int ra45 = 0; ra45 < 2; ++ra45) {
              pool3_ra46: for (int ra46 = 0; ra46 < 2; ++ra46) {
                ...
                pool3_pad_temp1 = pool3_pad_pipe_8.read();
                reducer6 = hls::max(pool3_pad_temp1, reducer6);
              }
            }
            ap_ufixed<4, 0> pool3_temp;
            pool3_temp = reducer6;
            pool3_pipe_9.write(pool3_temp);
          }
        }
      }
    }
        ...
        conv4_pad_index_tuple6: for (int index_tuple6 = 0; index_tuple6 < 22; ++index_tuple6) {
          ...
          #pragma HLS pipeline
            ...
            if ((((1 <= index_tuple6) && (index_tuple6 < 21)) && (1 <= i9)) && (i9 < 41)) {
              pool3_temp1 = pool3_pipe_9.read();
              // conv4_pad[indices6][not_zero6][index_tuple6][i9] = pool3_temp1;
              conv_pad_buf[indices6][not_zero6][index_tuple6][i9] = pool3_temp1;
            } else {
              pool3_temp1 = 0;
              // conv4_pad[indices6][not_zero6][index_tuple6][i9] = (ap_ufixed<4, 0>)0;
              conv_pad_buf[indices6][not_zero6][index_tuple6][i9] = (ap_ufixed<4, 0>)0;
            }
          }
        }
      }
    ...
    // Convolution
    convolution(weight_conv4,
                conv_pad_buf, 64, 22, 42,
                conv_buf, 64, 20, 40,
                conv_line_buffer_buf, 64, 3, 42,
                conv_window_buffer_buf, 64, 3, 3); 
                ...
                // conv4_ra47: for (int ra47 = 0; ra47 < 64; ++ra47) {
                  // conv4_ra48: for (int ra48 = 0; ra48 < 3; ++ra48) {
                    // conv4_ra49: for (int ra49 = 0; ra49 < 3; ++ra49) {
                      // sum___ = ((ap_fixed<16, 8>)(((ap_fixed<17, 9>)(((ap_fixed<10, 6>)((ap_fixed<9, 5>)conv4_window_buffer[0][ra47][ra48][ra49])) * ((ap_fixed<10, 6>)((ap_fixed<9, 6>)weight_conv4[ff3][ra47][ra48][ra49])))) + ((ap_fixed<17, 9>)sum___)));
                    // }
                  // }
                // }
    ...
    hls::stream<ap_ufixed<4, 0> > relu4_pipe_10;
    #pragma HLS stream variable=relu4_pipe_10 depth=128
      ...
      relu4_args03: for (int args03 = 0; args03 < 64; ++args03) {
        relu4_args13: for (int args13 = 0; args13 < 20; ++args13) {
          ...
          #pragma HLS pipeline
            ...
            // batch_norm4 = ((ap_fixed<16, 8>)(((ap_fixed<31, 13>)(((ap_fixed<30, 20>)a_batchnorm4[args03]) * ((ap_fixed<30, 22>)conv4[y3][args03][args13][args23]))) + ((ap_fixed<31, 13>)b_batchnorm4[args03])));
            batch_norm4 = ((ap_fixed<16, 8>)(((ap_fixed<31, 13>)(((ap_fixed<30, 20>)a_batchnorm4[args03]) * ((ap_fixed<30, 22>)conv_buf[y3][args03][args13][args23]))) + ((ap_fixed<31, 13>)b_batchnorm4[args03])));            
            ...
            relu4_pipe_10.write(relu4_temp);
          }
        }
      }
    }
    ap_ufixed<4, 0> pool4_pad[1][64][20][40];
    hls::stream<ap_ufixed<4, 0> > pool4_pad_pipe_11;
    #pragma HLS stream variable=pool4_pad_pipe_11 depth=128
      ...
      pool4_pad_not_zero7: for (int not_zero7 = 0; not_zero7 < 64; ++not_zero7) {
        pool4_pad_index_tuple7: for (int index_tuple7 = 0; index_tuple7 < 20; ++index_tuple7) {
          ...
          #pragma HLS pipeline
            ...
            relu4_temp1 = relu4_pipe_10.read();
            ap_ufixed<4, 0> pool4_pad_temp;
            pool4_pad_temp = relu4_temp1;
            pool4_pad_pipe_11.write(pool4_pad_temp);
          }
        }
      }
    }
    ap_ufixed<4, 0> pool4[1][64][10][20];
    hls::stream<ap_ufixed<4, 0> > pool4_pipe_12;
    #pragma HLS stream variable=pool4_pipe_12 depth=128
          ...
          #pragma HLS pipeline
            ...
            pool4_ra50: for (int ra50 = 0; ra50 < 2; ++ra50) {
              pool4_ra51: for (int ra51 = 0; ra51 < 2; ++ra51) {
                ...
                pool4_pad_temp1 = pool4_pad_pipe_11.read();
                reducer7 = hls::max(pool4_pad_temp1, reducer7);
              }
            }
            ap_ufixed<4, 0> pool4_temp;
            pool4_temp = reducer7;
            pool4_pipe_12.write(pool4_temp);
          }
        }
      }
    }
        ...
        conv5_pad_index_tuple8: for (int index_tuple8 = 0; index_tuple8 < 12; ++index_tuple8) {
          ...
          #pragma HLS pipeline
            ...
            if ((((1 <= index_tuple8) && (index_tuple8 < 11)) && (1 <= i12)) && (i12 < 21)) {
              pool4_temp1 = pool4_pipe_12.read();
              // conv5_pad[indices8][not_zero8][index_tuple8][i12] = pool4_temp1;
              conv_pad_buf[indices8][not_zero8][index_tuple8][i12] = pool4_temp1;
            } else {
              pool4_temp1 = 0;
              // conv5_pad[indices8][not_zero8][index_tuple8][i12] = (ap_ufixed<4, 0>)0;
              conv_pad_buf[indices8][not_zero8][index_tuple8][i12] = (ap_ufixed<4, 0>)0;
            }
          }
        }
      }
    ...
    // Convolution
    convolution(weight_conv5,
                conv_pad_buf, 64, 12, 222,
                conv_buf, 64, 10, 20,
                conv_line_buffer_buf, 64, 3, 22,
                conv_window_buffer_buf, 64, 3, 3);
                ...
                // conv5_ra52: for (int ra52 = 0; ra52 < 64; ++ra52) {
                  // conv5_ra53: for (int ra53 = 0; ra53 < 3; ++ra53) {
                    // conv5_ra54: for (int ra54 = 0; ra54 < 3; ++ra54) {
                      // sum____ = ((ap_fixed<16, 8>)(((ap_fixed<17, 9>)(((ap_fixed<10, 6>)((ap_fixed<9, 5>)conv5_window_buffer[0][ra52][ra53][ra54])) * ((ap_fixed<10, 6>)((ap_fixed<9, 6>)weight_conv5[ff4][ra52][ra53][ra54])))) + ((ap_fixed<17, 9>)sum____)));
                    // }
                  // }
                // }
    ...
    hls::stream<ap_ufixed<4, 0> > relu5_pipe_13;
    #pragma HLS stream variable=relu5_pipe_13 depth=128
      ...
      relu5_args04: for (int args04 = 0; args04 < 64; ++args04) {
        relu5_args14: for (int args14 = 0; args14 < 10; ++args14) {
          ...
          #pragma HLS pipeline
            ...
            // batch_norm5 = ((ap_fixed<16, 8>)(((ap_fixed<31, 13>)(((ap_fixed<30, 20>)a_batchnorm5[args04]) * ((ap_fixed<30, 22>)conv5[y4][args04][args14][args24]))) + ((ap_fixed<31, 13>)b_batchnorm5[args04])));
            batch_norm5 = ((ap_fixed<16, 8>)(((ap_fixed<31, 13>)(((ap_fixed<30, 20>)a_batchnorm5[args04]) * ((ap_fixed<30, 22>)conv_buf[y4][args04][args14][args24]))) + ((ap_fixed<31, 13>)b_batchnorm5[args04])));            
            ...
            relu5_pipe_13.write(relu5_temp);
          }
        }
      }
    }
        ...
        conv6_pad_index_tuple9: for (int index_tuple9 = 0; index_tuple9 < 12; ++index_tuple9) {
          ...
          #pragma HLS pipeline
            ...
            if ((((1 <= index_tuple9) && (index_tuple9 < 11)) && (1 <= i13)) && (i13 < 21)) {
              relu5_temp1 = relu5_pipe_13.read();
              // conv6_pad[indices9][not_zero9][index_tuple9][i13] = relu5_temp1;
              conv_pad_buf[indices9][not_zero9][index_tuple9][i13] = relu5_temp1;
            } else {
              relu5_temp1 = 0;
              // conv6_pad[indices9][not_zero9][index_tuple9][i13] = (ap_ufixed<4, 0>)0;
              conv_pad_buf[indices9][not_zero9][index_tuple9][i13] = (ap_ufixed<4, 0>)0;
            }
          }
        }
      }
    ...
    // Convolution
    convolution(weight_conv6,
                conv_pad_buf, 64, 12, 22,
                conv_buf, 64, 10, 20,
                conv_line_buffer_buf, 64, 3, 22,
                conv_window_buffer_buf, 64, 3, 3); 
                ...
                // conv6_ra55: for (int ra55 = 0; ra55 < 64; ++ra55) {
                  // conv6_ra56: for (int ra56 = 0; ra56 < 3; ++ra56) {
                    // conv6_ra57: for (int ra57 = 0; ra57 < 3; ++ra57) {
                      // sum_____ = ((ap_fixed<16, 8>)(((ap_fixed<17, 9>)(((ap_fixed<10, 6>)((ap_fixed<9, 5>)conv6_window_buffer[0][ra55][ra56][ra57])) * ((ap_fixed<10, 6>)((ap_fixed<9, 6>)weight_conv6[ff5][ra55][ra56][ra57])))) + ((ap_fixed<17, 9>)sum_____)));
                    // }
                  // }
                // }
    ...
    hls::stream<ap_ufixed<4, 0> > relu6_pipe_14;
    #pragma HLS stream variable=relu6_pipe_14 depth=128
      ...
      relu6_args05: for (int args05 = 0; args05 < 64; ++args05) {
        relu6_args15: for (int args15 = 0; args15 < 10; ++args15) {
          ...
          #pragma HLS pipeline
            ...
            // batch_norm6 = ((ap_fixed<16, 8>)(((ap_fixed<31, 13>)(((ap_fixed<30, 20>)a_batchnorm6[args05]) * ((ap_fixed<30, 22>)conv6[y5][args05][args15][args25]))) + ((ap_fixed<31, 13>)b_batchnorm6[args05])));
            batch_norm6 = ((ap_fixed<16, 8>)(((ap_fixed<31, 13>)(((ap_fixed<30, 20>)a_batchnorm6[args05]) * ((ap_fixed<30, 22>)conv_buf[y5][args05][args15][args25]))) + ((ap_fixed<31, 13>)b_batchnorm6[args05])));            
            ...
            relu6_pipe_14.write(relu6_temp);
          }
        }
      }
    }
        ...
        conv7_pad_index_tuple10: for (int index_tuple10 = 0; index_tuple10 < 12; ++index_tuple10) {
          ...
          #pragma HLS pipeline
            ...
            if ((((1 <= index_tuple10) && (index_tuple10 < 11)) && (1 <= i14)) && (i14 < 21)) {
              relu6_temp1 = relu6_pipe_14.read();
              // conv7_pad[indices10][not_zero10][index_tuple10][i14] = relu6_temp1;
              conv_pad_buf[indices10][not_zero10][index_tuple10][i14] = relu6_temp1;
            } else {
              relu6_temp1 = 0;
              // conv7_pad[indices10][not_zero10][index_tuple10][i14] = (ap_ufixed<4, 0>)0;
              conv_pad_buf[indices10][not_zero10][index_tuple10][i14] = (ap_ufixed<4, 0>)0;
            }
          }
        }
      }
                ...
                // conv7_ra58: for (int ra58 = 0; ra58 < 64; ++ra58) {
                  // conv7_ra59: for (int ra59 = 0; ra59 < 3; ++ra59) {
                    // conv7_ra60: for (int ra60 = 0; ra60 < 3; ++ra60) {
                      // sum______ = ((ap_fixed<16, 8>)(((ap_fixed<17, 9>)(((ap_fixed<10, 6>)((ap_fixed<9, 5>)conv7_window_buffer[0][ra58][ra59][ra60])) * ((ap_fixed<10, 6>)((ap_fixed<9, 6>)weight_conv7[ff6][ra58][ra59][ra60])))) + ((ap_fixed<17, 9>)sum______)));
                    // }
                  // }
                // }
    ...
    hls::stream<ap_ufixed<4, 0> > relu7_pipe_15;
    #pragma HLS stream variable=relu7_pipe_15 depth=128
      ...
      relu7_args06: for (int args06 = 0; args06 < 64; ++args06) {
        relu7_args16: for (int args16 = 0; args16 < 10; ++args16) {
          ...
          #pragma HLS pipeline
            ...
            // batch_norm7 = ((ap_fixed<16, 8>)(((ap_fixed<31, 13>)(((ap_fixed<30, 20>)a_batchnorm7[args06]) * ((ap_fixed<30, 22>)conv7[y6][args06][args16][args26]))) + ((ap_fixed<31, 13>)b_batchnorm7[args06])));
            batch_norm7 = ((ap_fixed<16, 8>)(((ap_fixed<31, 13>)(((ap_fixed<30, 20>)a_batchnorm7[args06]) * ((ap_fixed<30, 22>)conv_buf[y6][args06][args16][args26]))) + ((ap_fixed<31, 13>)b_batchnorm7[args06])));            
            ...
            relu7_pipe_15.write(relu7_temp);
          }
        }
      }
    }
        ...
        conv8_pad_index_tuple11: for (int index_tuple11 = 0; index_tuple11 < 12; ++index_tuple11) {
          ...
          #pragma HLS pipeline
            ...
            if ((((1 <= index_tuple11) && (index_tuple11 < 11)) && (1 <= i15)) && (i15 < 21)) {
              relu7_temp1 = relu7_pipe_15.read();
              // conv8_pad[indices11][not_zero11][index_tuple11][i15] = relu7_temp1;
              conv_pad_buf[indices11][not_zero11][index_tuple11][i15] = relu7_temp1;
            } else {
              relu7_temp1 = 0;
              // conv8_pad[indices11][not_zero11][index_tuple11][i15] = (ap_ufixed<4, 0>)0;
              conv_pad_buf[indices11][not_zero11][index_tuple11][i15] = (ap_ufixed<4, 0>)0;
            }
          }
        }
      }
                ...
                // conv8_ra61: for (int ra61 = 0; ra61 < 64; ++ra61) {
                  // conv8_ra62: for (int ra62 = 0; ra62 < 3; ++ra62) {
                    // conv8_ra63: for (int ra63 = 0; ra63 < 3; ++ra63) {
                      // sum_______ = ((ap_fixed<16, 8>)(((ap_fixed<17, 9>)(((ap_fixed<10, 6>)((ap_fixed<9, 5>)conv8_window_buffer[0][ra61][ra62][ra63])) * ((ap_fixed<10, 6>)((ap_fixed<9, 6>)weight_conv8[ff7][ra61][ra62][ra63])))) + ((ap_fixed<17, 9>)sum_______)));
                    // }
                  // }
                // }
      ...
      result_args07: for (int args07 = 0; args07 < 64; ++args07) {
        result_args17: for (int args17 = 0; args17 < 10; ++args17) {
          ...
          #pragma HLS pipeline
            ...
            // batch_norm8 = ((ap_fixed<16, 8>)(((ap_fixed<31, 13>)(((ap_fixed<30, 20>)a_batchnorm8[args07]) * ((ap_fixed<30, 22>)conv8[x12][args07][args17][args27]))) + ((ap_fixed<31, 13>)b_batchnorm8[args07])));
            batch_norm8 = ((ap_fixed<16, 8>)(((ap_fixed<31, 13>)(((ap_fixed<30, 20>)a_batchnorm8[args07]) * ((ap_fixed<30, 22>)conv_buf[x12][args07][args17][args27]))) + ((ap_fixed<31, 13>)b_batchnorm8[args07])));
            ...
            result[x12][args07][args17][args27] = ((ap_fixed<16, 8>)relu8);
          }
        }
      }
    }
