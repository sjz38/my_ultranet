...
// ==============================================================
#ifndef __test_mac_muladd_1dYM__HH__
#define __test_mac_muladd_1dYM__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(test_mac_muladd_1dYM) {
    ...
    SC_CTOR(test_mac_muladd_1dYM):  simcore_mac_14_U ("simcore_mac_14_U") {
