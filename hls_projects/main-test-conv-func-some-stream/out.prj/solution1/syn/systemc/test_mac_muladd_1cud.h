...
// ==============================================================
#ifndef __test_mac_muladd_1cud__HH__
#define __test_mac_muladd_1cud__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(test_mac_muladd_1cud) {
    ...
    SC_CTOR(test_mac_muladd_1cud):  simcore_mac_0_U ("simcore_mac_0_U") {
