...
// ==============================================================
#ifndef __Block_arrayctor_ldwH_H__
#define __Block_arrayctor_ldwH_H__
...
struct Block_arrayctor_ldwH_ram : public sc_core::sc_module {
...
sc_core::sc_signal<sc_lv<DataWidth> > q0_t1;
   SC_CTOR(Block_arrayctor_ldwH_ram) {
...
SC_MODULE(Block_arrayctor_ldwH) {
...
Block_arrayctor_ldwH_ram* meminst;


SC_CTOR(Block_arrayctor_ldwH) {
meminst = new Block_arrayctor_ldwH_ram("Block_arrayctor_ldwH_ram");
