...
// ==============================================================
#ifndef __test_mac_muladd_4dVL__HH__
#define __test_mac_muladd_4dVL__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(test_mac_muladd_4dVL) {
    ...
    SC_CTOR(test_mac_muladd_4dVL):  simcore_mac_11_U ("simcore_mac_11_U") {
