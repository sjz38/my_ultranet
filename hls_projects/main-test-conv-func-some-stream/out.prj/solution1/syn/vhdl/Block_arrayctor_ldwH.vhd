...
entity Block_arrayctor_ldwH_ram is 
    generic(
            MEM_TYPE    : string := "block"; 
            DWIDTH     : integer := 16; 
            AWIDTH     : integer := 22; 
            MEM_SIZE    : integer := 3276800
    ); 
    port (
...
architecture rtl of Block_arrayctor_ldwH_ram is 
...
entity Block_arrayctor_ldwH is
    generic (
        DataWidth : INTEGER := 16;
        AddressRange : INTEGER := 3276800;
...
architecture arch of Block_arrayctor_ldwH is
    component Block_arrayctor_ldwH_ram is
        port (
            clk : IN STD_LOGIC;
...
begin
    Block_arrayctor_ldwH_ram_U :  component Block_arrayctor_ldwH_ram
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
