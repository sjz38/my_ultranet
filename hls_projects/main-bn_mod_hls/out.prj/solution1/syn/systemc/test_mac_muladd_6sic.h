...
// ==============================================================
#ifndef __test_mac_muladd_6sic__HH__
#define __test_mac_muladd_6sic__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(test_mac_muladd_6sic) {
    ...
    SC_CTOR(test_mac_muladd_6sic):  simcore_mac_4_U ("simcore_mac_4_U") {
