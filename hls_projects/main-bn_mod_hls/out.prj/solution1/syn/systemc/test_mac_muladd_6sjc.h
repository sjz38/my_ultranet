...
// ==============================================================
#ifndef __test_mac_muladd_6sjc__HH__
#define __test_mac_muladd_6sjc__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(test_mac_muladd_6sjc) {
    ...
    SC_CTOR(test_mac_muladd_6sjc):  simcore_mac_5_U ("simcore_mac_5_U") {
