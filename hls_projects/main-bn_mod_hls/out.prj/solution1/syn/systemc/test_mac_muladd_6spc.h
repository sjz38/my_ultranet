...
// ==============================================================
#ifndef __test_mac_muladd_6spc__HH__
#define __test_mac_muladd_6spc__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(test_mac_muladd_6spc) {
    ...
    SC_CTOR(test_mac_muladd_6spc):  simcore_mac_11_U ("simcore_mac_11_U") {
