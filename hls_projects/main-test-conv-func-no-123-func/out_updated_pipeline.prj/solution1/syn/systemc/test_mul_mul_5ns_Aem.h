...
// ==============================================================
#ifndef __test_mul_mul_5ns_Aem__HH__
#define __test_mul_mul_5ns_Aem__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(test_mul_mul_5ns_Aem) {
    ...
    SC_CTOR(test_mul_mul_5ns_Aem):  ACMP_smul_uu_U ("ACMP_smul_uu_U") {
