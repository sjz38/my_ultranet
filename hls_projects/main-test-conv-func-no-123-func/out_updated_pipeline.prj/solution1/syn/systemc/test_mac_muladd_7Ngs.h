...
// ==============================================================
#ifndef __test_mac_muladd_7Ngs__HH__
#define __test_mac_muladd_7Ngs__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(test_mac_muladd_7Ngs) {
    ...
    SC_CTOR(test_mac_muladd_7Ngs):  simcore_mac_15_U ("simcore_mac_15_U") {
