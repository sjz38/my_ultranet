...
// ==============================================================
#ifndef __test_ama_addmuladwdI__HH__
#define __test_ama_addmuladwdI__HH__
...
template<
    ...
    int din3_WIDTH,
    int dout_WIDTH>
SC_MODULE(test_ama_addmuladwdI) {
    ...
    SC_CTOR(test_ama_addmuladwdI):  simcore_ama_0_U ("simcore_ama_0_U") {
