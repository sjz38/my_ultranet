...
// ==============================================================
#ifndef __test_mul_mul_14s_zec__HH__
#define __test_mul_mul_14s_zec__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(test_mul_mul_14s_zec) {
    ...
    SC_CTOR(test_mul_mul_14s_zec):  ACMP_smul_ss_U ("ACMP_smul_ss_U") {
