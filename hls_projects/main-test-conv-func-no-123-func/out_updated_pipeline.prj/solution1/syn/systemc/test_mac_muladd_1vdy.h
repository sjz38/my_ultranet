...
// ==============================================================
#ifndef __test_mac_muladd_1vdy__HH__
#define __test_mac_muladd_1vdy__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(test_mac_muladd_1vdy) {
    ...
    SC_CTOR(test_mac_muladd_1vdy):  simcore_mac_4_U ("simcore_mac_4_U") {
