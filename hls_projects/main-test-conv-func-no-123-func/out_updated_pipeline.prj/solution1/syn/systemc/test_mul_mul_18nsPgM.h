...
// ==============================================================
#ifndef __test_mul_mul_18nsPgM__HH__
#define __test_mul_mul_18nsPgM__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(test_mul_mul_18nsPgM) {
    ...
    SC_CTOR(test_mul_mul_18nsPgM):  ACMP_smul_us_U ("ACMP_smul_us_U") {
