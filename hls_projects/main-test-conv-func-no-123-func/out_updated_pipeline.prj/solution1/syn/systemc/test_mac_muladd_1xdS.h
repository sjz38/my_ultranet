...
// ==============================================================
#ifndef __test_mac_muladd_1xdS__HH__
#define __test_mac_muladd_1xdS__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(test_mac_muladd_1xdS) {
    ...
    SC_CTOR(test_mac_muladd_1xdS):  simcore_mac_5_U ("simcore_mac_5_U") {
