...
// ==============================================================
#ifndef __test_mac_muladd_9Ee0__HH__
#define __test_mac_muladd_9Ee0__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(test_mac_muladd_9Ee0) {
    ...
    SC_CTOR(test_mac_muladd_9Ee0):  simcore_mac_10_U ("simcore_mac_10_U") {
