...
// ==============================================================
#ifndef __test_mac_muladd_5Bew__HH__
#define __test_mac_muladd_5Bew__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(test_mac_muladd_5Bew) {
    ...
    SC_CTOR(test_mac_muladd_5Bew):  simcore_mac_7_U ("simcore_mac_7_U") {
