...
// ==============================================================
#ifndef __test_mac_muladd_1ncg__HH__
#define __test_mac_muladd_1ncg__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(test_mac_muladd_1ncg) {
    ...
    SC_CTOR(test_mac_muladd_1ncg):  simcore_mac_5_U ("simcore_mac_5_U") {
