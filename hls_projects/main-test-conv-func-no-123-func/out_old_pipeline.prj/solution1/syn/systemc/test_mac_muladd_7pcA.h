...
// ==============================================================
#ifndef __test_mac_muladd_7pcA__HH__
#define __test_mac_muladd_7pcA__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(test_mac_muladd_7pcA) {
    ...
    SC_CTOR(test_mac_muladd_7pcA):  simcore_mac_6_U ("simcore_mac_6_U") {
