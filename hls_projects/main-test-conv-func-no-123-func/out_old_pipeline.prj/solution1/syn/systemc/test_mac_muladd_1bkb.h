...
// ==============================================================
#ifndef __test_mac_muladd_1bkb__HH__
#define __test_mac_muladd_1bkb__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(test_mac_muladd_1bkb) {
    ...
    SC_CTOR(test_mac_muladd_1bkb):  simcore_mac_0_U ("simcore_mac_0_U") {
