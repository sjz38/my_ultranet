...
void test(ap_fixed<8, 4> input_image[1][3][160][320], ap_fixed<5, 2> weight_conv1[16][3][3][3], ap_fixed<14, 4> a_batchnorm1[16], ap_fixed<26, 8> b_batchnorm1[16], ap_fixed<5, 2> weight_conv2[32][16][3][3], ap_fixed<14, 4> a_batchnorm2[32], ap_fixed<26, 8> b_batchnorm2[32], ap_fixed<5, 2> weight_conv3[64][32][3][3], ap_fixed<14, 4> a_batchnorm3[64], ap_fixed<26, 8> b_batchnorm3[64], ap_fixed<5, 2> weight_conv4[64][64][3][3], ap_fixed<14, 4> a_batchnorm4[64], ap_fixed<26, 8> b_batchnorm4[64], ap_fixed<5, 2> weight_conv5[64][64][3][3], ap_fixed<14, 4> a_batchnorm5[64], ap_fixed<26, 8> b_batchnorm5[64], ap_fixed<5, 2> weight_conv6[64][64][3][3], ap_fixed<14, 4> a_batchnorm6[64], ap_fixed<26, 8> b_batchnorm6[64], ap_fixed<5, 2> weight_conv7[64][64][3][3], ap_fixed<14, 4> a_batchnorm7[64], ap_fixed<26, 8> b_batchnorm7[64], ap_fixed<5, 2> weight_conv8[64][64][3][3], ap_fixed<14, 4> a_batchnorm8[64], ap_fixed<26, 8> b_batchnorm8[64], ap_fixed<16, 8> result[1][64][10][20]) {
      ...
      conv2_pad_not_zero2: for (int not_zero2 = 0; not_zero2 < 16; ++not_zero2) {
        conv2_pad_index_tuple2: for (int index_tuple2 = 0; index_tuple2 < 82; ++index_tuple2) {
          ...
          #pragma HLS pipeline
            ...
            // conv_pad_buf[indices2][not_zero2][index_tuple2][i3] = (((((1 <= index_tuple2) && (index_tuple2 < 81)) && (1 <= i3)) && (i3 < 161)) ? ((ap_ufixed<4, 0>)pool1[((((((i3 - ((i3 + -1) % 160)) + (index_tuple2 * 160)) + (not_zero2 * 12800)) + (indices2 * 204800)) + -161) / 204800)][(((((((i3 - ((i3 + -1) % 160)) + (index_tuple2 * 160)) + (not_zero2 * 12800)) + (indices2 * 204800)) + -161) / 12800) % 16)][(((((((i3 - ((i3 + -1) % 160)) + (index_tuple2 * 160)) + (not_zero2 * 12800)) + (indices2 * 204800)) + -161) / 160) % 80)][((i3 + -1) % 160)]) : ((ap_ufixed<4, 0>)0));
          }
        }
      }
    }
    ...
    // Convolution
    // convolution(weight_conv2,
    //             conv_pad_buf, 16, 82, 162,
    //             conv_buf, 32, 80, 160,
    //             conv_line_buffer_buf, 16, 3, 162,
    //             conv_window_buffer_buf, 16, 3, 3);
      ...
      relu2_args01: for (int args01 = 0; args01 < 32; ++args01) {
        relu2_args11: for (int args11 = 0; args11 < 80; ++args11) {
          ...
          #pragma HLS pipeline
            ...
            // batch_norm2 = ((ap_fixed<16, 8>)(((ap_fixed<31, 13>)(((ap_fixed<30, 20>)a_batchnorm2[args01]) * ((ap_fixed<30, 22>)conv_buf[y1][args01][args11][args21]))) + ((ap_fixed<31, 13>)b_batchnorm2[args01])));
      ...
      conv3_pad_not_zero4: for (int not_zero4 = 0; not_zero4 < 32; ++not_zero4) {
        conv3_pad_index_tuple4: for (int index_tuple4 = 0; index_tuple4 < 42; ++index_tuple4) {
          ...
          #pragma HLS pipeline
            ...
            // conv_pad_buf[indices4][not_zero4][index_tuple4][i6] = (((((1 <= index_tuple4) && (index_tuple4 < 41)) && (1 <= i6)) && (i6 < 81)) ? ((ap_ufixed<4, 0>)pool2[((((((i6 - ((i6 + -1) % 80)) + (index_tuple4 * 80)) + (not_zero4 * 3200)) + (indices4 * 102400)) + -81) / 102400)][(((((((i6 - ((i6 + -1) % 80)) + (index_tuple4 * 80)) + (not_zero4 * 3200)) + (indices4 * 102400)) + -81) / 3200) % 32)][(((((((i6 - ((i6 + -1) % 80)) + (index_tuple4 * 80)) + (not_zero4 * 3200)) + (indices4 * 102400)) + -81) / 80) % 40)][((i6 + -1) % 80)]) : ((ap_ufixed<4, 0>)0));
          }
        }
      }
    }
    ...
    // Convolution
    // convolution(weight_conv3,
    //             conv_pad_buf, 32, 42, 82,
    //             conv_buf, 64, 40, 80,
    //             conv_line_buffer_buf, 32, 3, 82,
    //             conv_window_buffer_buf, 32, 3, 3);
      ...
      relu3_args02: for (int args02 = 0; args02 < 64; ++args02) {
        relu3_args12: for (int args12 = 0; args12 < 40; ++args12) {
          ...
          #pragma HLS pipeline
            ...
            // batch_norm3 = ((ap_fixed<16, 8>)(((ap_fixed<31, 13>)(((ap_fixed<30, 20>)a_batchnorm3[args02]) * ((ap_fixed<30, 22>)conv_buf[y2][args02][args12][args22]))) + ((ap_fixed<31, 13>)b_batchnorm3[args02])));
    ...
    conv5_pad_indices8: for (int indices8 = 0; indices8 < 1; ++indices8) {
      conv5_pad_not_zero8: for (int not_zero8 = 0; not_zero8 < 64; ++not_zero8) {
        conv5_pad_index_tuple8: for (int index_tuple8 = 0; index_tuple8 < 12; ++index_tuple8) {
          ...
          #pragma HLS pipeline
            conv_pad_buf[indices8][not_zero8][index_tuple8][i12] = (((((1 <= index_tuple8) && (index_tuple8 < 11)) && (1 <= i12)) && (i12 < 21)) ? ((ap_ufixed<4, 0>)pool4[((((((i12 - ((i12 + -1) % 20)) + (index_tuple8 * 20)) + (not_zero8 * 200)) + (indices8 * 12800)) + -21) / 12800)][(((((((i12 - ((i12 + -1) % 20)) + (index_tuple8 * 20)) + (not_zero8 * 200)) + (indices8 * 12800)) + -21) / 200) % 64)][(((((((i12 - ((i12 + -1) % 20)) + (index_tuple8 * 20)) + (not_zero8 * 200)) + (indices8 * 12800)) + -21) / 20) % 10)][((i12 + -1) % 20)]) : ((ap_ufixed<4, 0>)0));
          }
        }
      }
    }
      ...
      relu5_args04: for (int args04 = 0; args04 < 64; ++args04) {
        relu5_args14: for (int args14 = 0; args14 < 10; ++args14) {
          ...
          #pragma HLS pipeline
            ...
            relu5[y4][args04][args14][args24] = ((ap_ufixed<4, 0>)((((ap_fixed<40, 32>)batch_norm5) < (ap_fixed<40, 32>)0) ? (((ap_fixed<16, 8>)0)) : ((ap_fixed<16, 8>)(((ap_fixed<40, 32>)1 < ((ap_fixed<40, 32>)batch_norm5)) ? (((ap_fixed<16, 8>)1)) : ((ap_fixed<16, 8>)batch_norm5)))));
          }
        }
      }
    }
    ...
    conv6_pad_indices9: for (int indices9 = 0; indices9 < 1; ++indices9) {
      conv6_pad_not_zero9: for (int not_zero9 = 0; not_zero9 < 64; ++not_zero9) {
        conv6_pad_index_tuple9: for (int index_tuple9 = 0; index_tuple9 < 12; ++index_tuple9) {
          ...
          #pragma HLS pipeline
            conv_pad_buf[indices9][not_zero9][index_tuple9][i13] = (((((1 <= index_tuple9) && (index_tuple9 < 11)) && (1 <= i13)) && (i13 < 21)) ? ((ap_ufixed<4, 0>)relu5[((((((i13 - ((i13 + -1) % 20)) + (index_tuple9 * 20)) + (not_zero9 * 200)) + (indices9 * 12800)) + -21) / 12800)][(((((((i13 - ((i13 + -1) % 20)) + (index_tuple9 * 20)) + (not_zero9 * 200)) + (indices9 * 12800)) + -21) / 200) % 64)][(((((((i13 - ((i13 + -1) % 20)) + (index_tuple9 * 20)) + (not_zero9 * 200)) + (indices9 * 12800)) + -21) / 20) % 10)][((i13 + -1) % 20)]) : ((ap_ufixed<4, 0>)0));
          }
        }
      }
    }
      ...
      relu6_args05: for (int args05 = 0; args05 < 64; ++args05) {
        relu6_args15: for (int args15 = 0; args15 < 10; ++args15) {
          ...
          #pragma HLS pipeline
            ...
            relu6[y5][args05][args15][args25] = ((ap_ufixed<4, 0>)((((ap_fixed<40, 32>)batch_norm6) < (ap_fixed<40, 32>)0) ? (((ap_fixed<16, 8>)0)) : ((ap_fixed<16, 8>)(((ap_fixed<40, 32>)1 < ((ap_fixed<40, 32>)batch_norm6)) ? (((ap_fixed<16, 8>)1)) : ((ap_fixed<16, 8>)batch_norm6)))));
          }
        }
      }
    }
    ...
    conv7_pad_indices10: for (int indices10 = 0; indices10 < 1; ++indices10) {
      conv7_pad_not_zero10: for (int not_zero10 = 0; not_zero10 < 64; ++not_zero10) {
        conv7_pad_index_tuple10: for (int index_tuple10 = 0; index_tuple10 < 12; ++index_tuple10) {
          ...
          #pragma HLS pipeline
            conv_pad_buf[indices10][not_zero10][index_tuple10][i14] = (((((1 <= index_tuple10) && (index_tuple10 < 11)) && (1 <= i14)) && (i14 < 21)) ? ((ap_ufixed<4, 0>)relu6[((((((i14 - ((i14 + -1) % 20)) + (index_tuple10 * 20)) + (not_zero10 * 200)) + (indices10 * 12800)) + -21) / 12800)][(((((((i14 - ((i14 + -1) % 20)) + (index_tuple10 * 20)) + (not_zero10 * 200)) + (indices10 * 12800)) + -21) / 200) % 64)][(((((((i14 - ((i14 + -1) % 20)) + (index_tuple10 * 20)) + (not_zero10 * 200)) + (indices10 * 12800)) + -21) / 20) % 10)][((i14 + -1) % 20)]) : ((ap_ufixed<4, 0>)0));
          }
        }
      }
    }
      ...
      relu7_args06: for (int args06 = 0; args06 < 64; ++args06) {
        relu7_args16: for (int args16 = 0; args16 < 10; ++args16) {
          ...
          #pragma HLS pipeline
            ...
            relu7[y6][args06][args16][args26] = ((ap_ufixed<4, 0>)((((ap_fixed<40, 32>)batch_norm7) < (ap_fixed<40, 32>)0) ? (((ap_fixed<16, 8>)0)) : ((ap_fixed<16, 8>)(((ap_fixed<40, 32>)1 < ((ap_fixed<40, 32>)batch_norm7)) ? (((ap_fixed<16, 8>)1)) : ((ap_fixed<16, 8>)batch_norm7)))));
          }
        }
      }
    }
    ...
    conv8_pad_indices11: for (int indices11 = 0; indices11 < 1; ++indices11) {
      conv8_pad_not_zero11: for (int not_zero11 = 0; not_zero11 < 64; ++not_zero11) {
        conv8_pad_index_tuple11: for (int index_tuple11 = 0; index_tuple11 < 12; ++index_tuple11) {
          ...
          #pragma HLS pipeline
            conv_pad_buf[indices11][not_zero11][index_tuple11][i15] = (((((1 <= index_tuple11) && (index_tuple11 < 11)) && (1 <= i15)) && (i15 < 21)) ? ((ap_ufixed<4, 0>)relu7[((((((i15 - ((i15 + -1) % 20)) + (index_tuple11 * 20)) + (not_zero11 * 200)) + (indices11 * 12800)) + -21) / 12800)][(((((((i15 - ((i15 + -1) % 20)) + (index_tuple11 * 20)) + (not_zero11 * 200)) + (indices11 * 12800)) + -21) / 200) % 64)][(((((((i15 - ((i15 + -1) % 20)) + (index_tuple11 * 20)) + (not_zero11 * 200)) + (indices11 * 12800)) + -21) / 20) % 10)][((i15 + -1) % 20)]) : ((ap_ufixed<4, 0>)0));
          }
        }
      }
    }
