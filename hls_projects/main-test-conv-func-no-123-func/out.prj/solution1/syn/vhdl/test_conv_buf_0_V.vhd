...
entity test_conv_buf_0_V_ram is 
    generic(
...
architecture rtl of test_conv_buf_0_V_ram is 
...
architecture arch of test_conv_buf_0_V is
    component test_conv_buf_0_V_ram is
        port (
            clk : IN STD_LOGIC;
...
begin
    test_conv_buf_0_V_ram_U :  component test_conv_buf_0_V_ram
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
