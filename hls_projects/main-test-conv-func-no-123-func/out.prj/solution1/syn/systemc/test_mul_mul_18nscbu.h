...
// ==============================================================
#ifndef __test_mul_mul_18nscbu__HH__
#define __test_mul_mul_18nscbu__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(test_mul_mul_18nscbu) {
    ...
    SC_CTOR(test_mul_mul_18nscbu):  ACMP_smul_us_U ("ACMP_smul_us_U") {
