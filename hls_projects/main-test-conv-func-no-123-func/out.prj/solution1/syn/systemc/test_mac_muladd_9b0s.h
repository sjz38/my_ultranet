...
// ==============================================================
#ifndef __test_mac_muladd_9b0s__HH__
#define __test_mac_muladd_9b0s__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(test_mac_muladd_9b0s) {
    ...
    SC_CTOR(test_mac_muladd_9b0s):  simcore_mac_5_U ("simcore_mac_5_U") {
