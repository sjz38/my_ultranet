...
// ==============================================================
#ifndef __test_mul_mul_20nsb9t__HH__
#define __test_mul_mul_20nsb9t__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(test_mul_mul_20nsb9t) {
    ...
    SC_CTOR(test_mul_mul_20nsb9t):  ACMP_smul_us_U ("ACMP_smul_us_U") {
