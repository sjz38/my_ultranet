...
// ==============================================================
#ifndef __test_mul_mul_22nsbTr__HH__
#define __test_mul_mul_22nsbTr__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(test_mul_mul_22nsbTr) {
    ...
    SC_CTOR(test_mul_mul_22nsbTr):  ACMP_smul_us_U ("ACMP_smul_us_U") {
