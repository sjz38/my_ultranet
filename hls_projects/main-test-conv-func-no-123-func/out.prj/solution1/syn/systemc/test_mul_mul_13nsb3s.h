...
// ==============================================================
#ifndef __test_mul_mul_13nsb3s__HH__
#define __test_mul_mul_13nsb3s__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(test_mul_mul_13nsb3s) {
    ...
    SC_CTOR(test_mul_mul_13nsb3s):  ACMP_smul_uu_U ("ACMP_smul_uu_U") {
