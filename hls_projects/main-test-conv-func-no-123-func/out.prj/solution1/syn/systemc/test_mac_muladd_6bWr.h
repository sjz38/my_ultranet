...
// ==============================================================
#ifndef __test_mac_muladd_6bWr__HH__
#define __test_mac_muladd_6bWr__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(test_mac_muladd_6bWr) {
    ...
    SC_CTOR(test_mac_muladd_6bWr):  simcore_mac_4_U ("simcore_mac_4_U") {
