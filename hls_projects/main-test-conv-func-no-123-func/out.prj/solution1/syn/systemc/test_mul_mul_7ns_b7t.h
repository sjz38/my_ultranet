...
// ==============================================================
#ifndef __test_mul_mul_7ns_b7t__HH__
#define __test_mul_mul_7ns_b7t__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(test_mul_mul_7ns_b7t) {
    ...
    SC_CTOR(test_mul_mul_7ns_b7t):  ACMP_smul_uu_U ("ACMP_smul_uu_U") {
