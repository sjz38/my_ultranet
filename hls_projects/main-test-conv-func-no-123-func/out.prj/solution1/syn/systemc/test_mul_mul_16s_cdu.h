...
// ==============================================================
#ifndef __test_mul_mul_16s_cdu__HH__
#define __test_mul_mul_16s_cdu__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(test_mul_mul_16s_cdu) {
    ...
    SC_CTOR(test_mul_mul_16s_cdu):  ACMP_smul_ss_U ("ACMP_smul_ss_U") {
