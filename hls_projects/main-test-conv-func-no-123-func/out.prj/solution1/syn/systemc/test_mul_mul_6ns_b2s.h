...
// ==============================================================
#ifndef __test_mul_mul_6ns_b2s__HH__
#define __test_mul_mul_6ns_b2s__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(test_mul_mul_6ns_b2s) {
    ...
    SC_CTOR(test_mul_mul_6ns_b2s):  ACMP_smul_uu_U ("ACMP_smul_uu_U") {
