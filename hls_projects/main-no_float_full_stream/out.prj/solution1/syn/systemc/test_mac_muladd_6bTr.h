...
// ==============================================================
#ifndef __test_mac_muladd_6bTr__HH__
#define __test_mac_muladd_6bTr__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(test_mac_muladd_6bTr) {
    ...
    SC_CTOR(test_mac_muladd_6bTr):  simcore_mac_7_U ("simcore_mac_7_U") {
