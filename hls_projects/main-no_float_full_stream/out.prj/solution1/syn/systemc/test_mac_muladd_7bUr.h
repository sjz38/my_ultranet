...
// ==============================================================
#ifndef __test_mac_muladd_7bUr__HH__
#define __test_mac_muladd_7bUr__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(test_mac_muladd_7bUr) {
    ...
    SC_CTOR(test_mac_muladd_7bUr):  simcore_mac_8_U ("simcore_mac_8_U") {
