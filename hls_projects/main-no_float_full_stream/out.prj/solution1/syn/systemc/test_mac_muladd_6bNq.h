...
// ==============================================================
#ifndef __test_mac_muladd_6bNq__HH__
#define __test_mac_muladd_6bNq__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(test_mac_muladd_6bNq) {
    ...
    SC_CTOR(test_mac_muladd_6bNq):  simcore_mac_1_U ("simcore_mac_1_U") {
