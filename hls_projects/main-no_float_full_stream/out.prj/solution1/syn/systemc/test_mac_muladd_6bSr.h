...
// ==============================================================
#ifndef __test_mac_muladd_6bSr__HH__
#define __test_mac_muladd_6bSr__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(test_mac_muladd_6bSr) {
    ...
    SC_CTOR(test_mac_muladd_6bSr):  simcore_mac_6_U ("simcore_mac_6_U") {
