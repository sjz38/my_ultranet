...
void test(ap_fixed<8, 4> input_image[1][3][160][320], ap_fixed<5, 2> weight_conv1[16][3][3][3], ap_fixed<14, 4> a_batchnorm1[16], ap_fixed<26, 8> b_batchnorm1[16], ap_fixed<5, 2> weight_conv2[32][16][3][3], ap_fixed<14, 4> a_batchnorm2[32], ap_fixed<26, 8> b_batchnorm2[32], ap_fixed<5, 2> weight_conv3[64][32][3][3], ap_fixed<14, 4> a_batchnorm3[64], ap_fixed<26, 8> b_batchnorm3[64], ap_fixed<5, 2> weight_conv4[64][64][3][3], ap_fixed<14, 4> a_batchnorm4[64], ap_fixed<26, 8> b_batchnorm4[64], ap_fixed<5, 2> weight_conv5[64][64][3][3], ap_fixed<14, 4> a_batchnorm5[64], ap_fixed<26, 8> b_batchnorm5[64], ap_fixed<5, 2> weight_conv6[64][64][3][3], ap_fixed<14, 4> a_batchnorm6[64], ap_fixed<26, 8> b_batchnorm6[64], ap_fixed<5, 2> weight_conv7[64][64][3][3], ap_fixed<14, 4> a_batchnorm7[64], ap_fixed<26, 8> b_batchnorm7[64], ap_fixed<5, 2> weight_conv8[64][64][3][3], ap_fixed<14, 4> a_batchnorm8[64], ap_fixed<26, 8> b_batchnorm8[64], ap_fixed<16, 8> result[1][64][10][20]) {
    ...
    hls::stream<ap_ufixed<4, 0> > relu1_pipe_10;
    ...
    hls::stream<ap_ufixed<4, 0> > pool1_pad_pipe_11;
    ...
    hls::stream<ap_ufixed<4, 0> > pool1_pipe_12;
    ...
    hls::stream<ap_ufixed<4, 0> > conv2_pad_pipe_2;
        ...
        conv2_pad_index_tuple2: for (int index_tuple2 = 0; index_tuple2 < 82; ++index_tuple2) {
          ...
          #pragma HLS pipeline
            ...
            if ((((1 <= index_tuple2) && (index_tuple2 < 81)) && (1 <= i3)) && (i3 < 161)) {
              ...
              pool1_temp1 = 0;
              conv2_pad_temp = (ap_ufixed<4, 0>)0;
            }
    ...
    hls::stream<ap_ufixed<4, 0> > relu2_pipe_14;
    ...
    hls::stream<ap_ufixed<4, 0> > pool2_pad_pipe_15;
    ...
    hls::stream<ap_ufixed<4, 0> > pool2_pipe_16;
    ...
    hls::stream<ap_ufixed<4, 0> > conv3_pad_pipe_3;
        ...
        conv3_pad_index_tuple4: for (int index_tuple4 = 0; index_tuple4 < 42; ++index_tuple4) {
          ...
          #pragma HLS pipeline
            ...
            if ((((1 <= index_tuple4) && (index_tuple4 < 41)) && (1 <= i6)) && (i6 < 81)) {
              ...
              pool2_temp1 = 0;
              conv3_pad_temp = (ap_ufixed<4, 0>)0;
            }
    ...
    hls::stream<ap_ufixed<4, 0> > relu3_pipe_18;
    ...
    hls::stream<ap_ufixed<4, 0> > pool3_pad_pipe_19;
    ...
    hls::stream<ap_ufixed<4, 0> > pool3_pipe_20;
    ...
    hls::stream<ap_ufixed<4, 0> > conv4_pad_pipe_4;
        ...
        conv4_pad_index_tuple6: for (int index_tuple6 = 0; index_tuple6 < 22; ++index_tuple6) {
          ...
          #pragma HLS pipeline
            ...
            if ((((1 <= index_tuple6) && (index_tuple6 < 21)) && (1 <= i9)) && (i9 < 41)) {
              ...
              pool3_temp1 = 0;
              conv4_pad_temp = (ap_ufixed<4, 0>)0;
            }
    ...
    hls::stream<ap_ufixed<4, 0> > relu4_pipe_22;
    ...
    hls::stream<ap_ufixed<4, 0> > pool4_pad_pipe_23;
    ...
    hls::stream<ap_ufixed<4, 0> > pool4_pipe_24;
    ...
    hls::stream<ap_ufixed<4, 0> > conv5_pad_pipe_5;
        ...
        conv5_pad_index_tuple8: for (int index_tuple8 = 0; index_tuple8 < 12; ++index_tuple8) {
          ...
          #pragma HLS pipeline
            ...
            if ((((1 <= index_tuple8) && (index_tuple8 < 11)) && (1 <= i12)) && (i12 < 21)) {
              ...
              pool4_temp1 = 0;
              conv5_pad_temp = (ap_ufixed<4, 0>)0;
            }
    ...
    #pragma HLS array_partition variable=conv5_line_buffer complete dim=3
    ap_ufixed<4, 0> conv5_window_buffer[1][64][3][3];
    #pragma HLS array_partition variable=conv5_window_buffer complete dim=3
    #pragma HLS array_partition variable=conv5_window_buffer complete dim=4
    ...
    hls::stream<ap_ufixed<4, 0> > relu5_pipe_26;
    ...
    hls::stream<ap_ufixed<4, 0> > conv6_pad_pipe_6;
        ...
        conv6_pad_index_tuple9: for (int index_tuple9 = 0; index_tuple9 < 12; ++index_tuple9) {
          ...
          #pragma HLS pipeline
            ...
            if ((((1 <= index_tuple9) && (index_tuple9 < 11)) && (1 <= i13)) && (i13 < 21)) {
              ...
              relu5_temp1 = 0;
              conv6_pad_temp = (ap_ufixed<4, 0>)0;
            }
    ...
    #pragma HLS array_partition variable=conv6_line_buffer complete dim=3
    ap_ufixed<4, 0> conv6_window_buffer[1][64][3][3];
    #pragma HLS array_partition variable=conv6_window_buffer complete dim=3
    #pragma HLS array_partition variable=conv6_window_buffer complete dim=4
    ...
    hls::stream<ap_ufixed<4, 0> > relu6_pipe_28;
    ...
    hls::stream<ap_ufixed<4, 0> > conv7_pad_pipe_7;
        ...
        conv7_pad_index_tuple10: for (int index_tuple10 = 0; index_tuple10 < 12; ++index_tuple10) {
          ...
          #pragma HLS pipeline
            ...
            if ((((1 <= index_tuple10) && (index_tuple10 < 11)) && (1 <= i14)) && (i14 < 21)) {
              ...
              relu6_temp1 = 0;
              conv7_pad_temp = (ap_ufixed<4, 0>)0;
            }
    ...
    #pragma HLS array_partition variable=conv7_line_buffer complete dim=3
    ap_ufixed<4, 0> conv7_window_buffer[1][64][3][3];
    #pragma HLS array_partition variable=conv7_window_buffer complete dim=3
    #pragma HLS array_partition variable=conv7_window_buffer complete dim=4
    ...
    hls::stream<ap_ufixed<4, 0> > relu7_pipe_30;
    ...
    hls::stream<ap_ufixed<4, 0> > conv8_pad_pipe_8;
        ...
        conv8_pad_index_tuple11: for (int index_tuple11 = 0; index_tuple11 < 12; ++index_tuple11) {
          ...
          #pragma HLS pipeline
            ...
            if ((((1 <= index_tuple11) && (index_tuple11 < 11)) && (1 <= i15)) && (i15 < 21)) {
              ...
              relu7_temp1 = 0;
              conv8_pad_temp = (ap_ufixed<4, 0>)0;
            }
    ...
    #pragma HLS array_partition variable=conv8_line_buffer complete dim=3
    ap_ufixed<4, 0> conv8_window_buffer[1][64][3][3];
    #pragma HLS array_partition variable=conv8_window_buffer complete dim=3
    #pragma HLS array_partition variable=conv8_window_buffer complete dim=4
