...
// ==============================================================
#ifndef __test_mac_muladd_1trd__HH__
#define __test_mac_muladd_1trd__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(test_mac_muladd_1trd) {
    ...
    SC_CTOR(test_mac_muladd_1trd):  simcore_mac_2_U ("simcore_mac_2_U") {
