...
// ==============================================================
#ifndef __test_mac_muladd_5twd__HH__
#define __test_mac_muladd_5twd__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(test_mac_muladd_5twd) {
    ...
    SC_CTOR(test_mac_muladd_5twd):  simcore_mac_3_U ("simcore_mac_3_U") {
