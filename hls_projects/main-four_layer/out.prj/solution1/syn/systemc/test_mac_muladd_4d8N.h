...
// ==============================================================
#ifndef __test_mac_muladd_4d8N__HH__
#define __test_mac_muladd_4d8N__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(test_mac_muladd_4d8N) {
    ...
    SC_CTOR(test_mac_muladd_4d8N):  simcore_mac_6_U ("simcore_mac_6_U") {
