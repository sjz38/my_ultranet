...
// ==============================================================
#ifndef __test_mul_mul_22nsd0M__HH__
#define __test_mul_mul_22nsd0M__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(test_mul_mul_22nsd0M) {
    ...
    SC_CTOR(test_mul_mul_22nsd0M):  ACMP_smul_us_U ("ACMP_smul_us_U") {
