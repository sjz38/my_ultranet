...
// ==============================================================
#ifndef __test_mac_muladd_4d9N__HH__
#define __test_mac_muladd_4d9N__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(test_mac_muladd_4d9N) {
    ...
    SC_CTOR(test_mac_muladd_4d9N):  simcore_mac_7_U ("simcore_mac_7_U") {
