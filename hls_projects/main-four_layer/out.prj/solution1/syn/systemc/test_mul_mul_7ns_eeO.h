...
// ==============================================================
#ifndef __test_mul_mul_7ns_eeO__HH__
#define __test_mul_mul_7ns_eeO__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(test_mul_mul_7ns_eeO) {
    ...
    SC_CTOR(test_mul_mul_7ns_eeO):  ACMP_smul_uu_U ("ACMP_smul_uu_U") {
