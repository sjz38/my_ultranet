...
// ==============================================================
#ifndef __test_mul_mul_20nsefO__HH__
#define __test_mul_mul_20nsefO__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(test_mul_mul_20nsefO) {
    ...
    SC_CTOR(test_mul_mul_20nsefO):  ACMP_smul_us_U ("ACMP_smul_us_U") {
