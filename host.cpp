...
int main(int argc, char ** argv) {
  ...
  // write_file("boat_input.txt", input_image, 1, 160, 320, 3);

  auto arg_1 = new float[432];
  read_floats(arg_1,"/work/shared/users/meng/sjz38/tmp/my_ultranet/weight_dat_nhwc/conv1_weight.dat", 432);
  ...
  read_floats(arg_2,"/work/shared/users/meng/sjz38/tmp/my_ultranet/weight_dat_nhwc/batchnorm1_a.dat", 16);
  ...
  read_floats(arg_3,"/work/shared/users/meng/sjz38/tmp/my_ultranet/weight_dat_nhwc/batchnorm1_b.dat", 16);
  ...
  read_floats(arg_4,"/work/shared/users/meng/sjz38/tmp/my_ultranet/weight_dat_nhwc/conv2_weight.dat", 4608);
  ...
  read_floats(arg_5,"/work/shared/users/meng/sjz38/tmp/my_ultranet/weight_dat_nhwc/batchnorm2_a.dat", 32);
  ...
  read_floats(arg_6,"/work/shared/users/meng/sjz38/tmp/my_ultranet/weight_dat_nhwc/batchnorm2_b.dat", 32);
  ...
  read_floats(arg_7, "/work/shared/users/meng/sjz38/tmp/my_ultranet/weight_dat_nhwc/conv3_weight.dat", 18432);
  ...
  read_floats(arg_8, "/work/shared/users/meng/sjz38/tmp/my_ultranet/weight_dat_nhwc/batchnorm3_a.dat", 64);
  ...
  read_floats(arg_9, "/work/shared/users/meng/sjz38/tmp/my_ultranet/weight_dat_nhwc/batchnorm3_b.dat", 64);
  ...
  read_floats(arg_10, "/work/shared/users/meng/sjz38/tmp/my_ultranet/weight_dat_nhwc/conv4_weight.dat", 36864);
  ...
  read_floats(arg_11, "/work/shared/users/meng/sjz38/tmp/my_ultranet/weight_dat_nhwc/batchnorm4_a.dat", 64);
  ...
  read_floats(arg_12, "/work/shared/users/meng/sjz38/tmp/my_ultranet/weight_dat_nhwc/batchnorm4_b.dat", 64);
  ...
  read_floats(arg_13, "/work/shared/users/meng/sjz38/tmp/my_ultranet/weight_dat_nhwc/conv5_weight.dat", 36864);
  ...
  read_floats(arg_14, "/work/shared/users/meng/sjz38/tmp/my_ultranet/weight_dat_nhwc/batchnorm5_a.dat", 64);
  ...
  read_floats(arg_15, "/work/shared/users/meng/sjz38/tmp/my_ultranet/weight_dat_nhwc/batchnorm5_b.dat", 64);
  ...
  read_floats(arg_16, "/work/shared/users/meng/sjz38/tmp/my_ultranet/weight_dat_nhwc/conv6_weight.dat", 36864);
  ...
  read_floats(arg_17, "/work/shared/users/meng/sjz38/tmp/my_ultranet/weight_dat_nhwc/batchnorm6_a.dat", 64);
  ...
  read_floats(arg_18, "/work/shared/users/meng/sjz38/tmp/my_ultranet/weight_dat_nhwc/batchnorm6_b.dat", 64);
  ...
  read_floats(arg_19, "/work/shared/users/meng/sjz38/tmp/my_ultranet/weight_dat_nhwc/conv7_weight.dat", 36864);
  ...
  read_floats(arg_20, "/work/shared/users/meng/sjz38/tmp/my_ultranet/weight_dat_nhwc/batchnorm7_a.dat", 64);
  ...
  read_floats(arg_21, "/work/shared/users/meng/sjz38/tmp/my_ultranet/weight_dat_nhwc/batchnorm7_b.dat", 64);
  ...
  read_floats(arg_22, "/work/shared/users/meng/sjz38/tmp/my_ultranet/weight_dat_nhwc/conv8_weight.dat", 36864);
  ...
  read_floats(arg_23, "/work/shared/users/meng/sjz38/tmp/my_ultranet/weight_dat_nhwc/batchnorm8_a.dat", 64);
  ...
  read_floats(arg_24, "/work/shared/users/meng/sjz38/tmp/my_ultranet/weight_dat_nhwc/batchnorm8_b.dat", 64);
