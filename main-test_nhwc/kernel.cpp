            ...
            conv4_ff3: for (int ff3 = 0; ff3 < 64; ++ff3) {
              conv4_line_buffer_2: for (int conv4_line_buffer_2 = 0; conv4_line_buffer_2 < 3; ++conv4_line_buffer_2) {
                conv4_line_buffer_1: for (int conv4_line_buffer_1 = 0; conv4_line_buffer_1 < 2; ++conv4_line_buffer_1) {
                  conv4_window_buffer[0][conv4_line_buffer_2][conv4_line_buffer_1][ff3] = conv4_window_buffer[0][conv4_line_buffer_2][(conv4_line_buffer_1 + 1)][ff3];
                }
                conv4_window_buffer[0][conv4_line_buffer_2][2][ff3] = conv4_line_buffer[0][conv4_line_buffer_2][xx_reuse3][ff3];
              }
              if (2 <= xx_reuse3) {
            ...
            conv5_ff4: for (int ff4 = 0; ff4 < 64; ++ff4) {
              conv5_line_buffer_2: for (int conv5_line_buffer_2 = 0; conv5_line_buffer_2 < 3; ++conv5_line_buffer_2) {
                conv5_line_buffer_1: for (int conv5_line_buffer_1 = 0; conv5_line_buffer_1 < 2; ++conv5_line_buffer_1) {
                  conv5_window_buffer[0][conv5_line_buffer_2][conv5_line_buffer_1][ff4] = conv5_window_buffer[0][conv5_line_buffer_2][(conv5_line_buffer_1 + 1)][ff4];
                }
                conv5_window_buffer[0][conv5_line_buffer_2][2][ff4] = conv5_line_buffer[0][conv5_line_buffer_2][xx_reuse4][ff4];
              }
              if (2 <= xx_reuse4) {
            ...
            conv6_ff5: for (int ff5 = 0; ff5 < 64; ++ff5) {
              conv6_line_buffer_2: for (int conv6_line_buffer_2 = 0; conv6_line_buffer_2 < 3; ++conv6_line_buffer_2) {
                conv6_line_buffer_1: for (int conv6_line_buffer_1 = 0; conv6_line_buffer_1 < 2; ++conv6_line_buffer_1) {
                  conv6_window_buffer[0][conv6_line_buffer_2][conv6_line_buffer_1][ff5] = conv6_window_buffer[0][conv6_line_buffer_2][(conv6_line_buffer_1 + 1)][ff5];
                }
                conv6_window_buffer[0][conv6_line_buffer_2][2][ff5] = conv6_line_buffer[0][conv6_line_buffer_2][xx_reuse5][ff5];
              }
              if (2 <= xx_reuse5) {
            ...
            conv7_ff6: for (int ff6 = 0; ff6 < 64; ++ff6) {
              conv7_line_buffer_2: for (int conv7_line_buffer_2 = 0; conv7_line_buffer_2 < 3; ++conv7_line_buffer_2) {
                conv7_line_buffer_1: for (int conv7_line_buffer_1 = 0; conv7_line_buffer_1 < 2; ++conv7_line_buffer_1) {
                  conv7_window_buffer[0][conv7_line_buffer_2][conv7_line_buffer_1][ff6] = conv7_window_buffer[0][conv7_line_buffer_2][(conv7_line_buffer_1 + 1)][ff6];
                }
                conv7_window_buffer[0][conv7_line_buffer_2][2][ff6] = conv7_line_buffer[0][conv7_line_buffer_2][xx_reuse6][ff6];
              }
              if (2 <= xx_reuse6) {
            ...
            conv8_ff7: for (int ff7 = 0; ff7 < 64; ++ff7) {
              conv8_line_buffer_2: for (int conv8_line_buffer_2 = 0; conv8_line_buffer_2 < 3; ++conv8_line_buffer_2) {
                conv8_line_buffer_1: for (int conv8_line_buffer_1 = 0; conv8_line_buffer_1 < 2; ++conv8_line_buffer_1) {
                  conv8_window_buffer[0][conv8_line_buffer_2][conv8_line_buffer_1][ff7] = conv8_window_buffer[0][conv8_line_buffer_2][(conv8_line_buffer_1 + 1)][ff7];
                }
                conv8_window_buffer[0][conv8_line_buffer_2][2][ff7] = conv8_line_buffer[0][conv8_line_buffer_2][xx_reuse7][ff7];
              }
              if (2 <= xx_reuse7) {
